# 🧠 @ruv.io/kimi-fann-core

> Optimized micro-expert neural architecture for Kimi-K2 WASM conversion with 5-10x performance improvements

[![npm version](https://img.shields.io/npm/v/@ruv.io/kimi-fann-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/kimi-fann-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/kimi-fann-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/kimi-fann-core)
[![license](https://img.shields.io/npm/l/@ruv.io/kimi-fann-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/kimi-fann-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`kimi-fann-core`](https://crates.io/crates/kimi-fann-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/kimi-fann-core
```

### Using yarn

```bash
yarn add @ruv.io/kimi-fann-core
```

### Using pnpm

```bash
pnpm add @ruv.io/kimi-fann-core
```
...
- **Linux x64**: `@ruv.io/kimi-fann-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/kimi-fann-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/kimi-fann-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/kimi-fann-core-darwin-arm64`
- **Windows x64**: `@ruv.io/kimi-fann-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/kimi-fann-core-wasm32` (fallback)
...
```typescript
import { KimiFannCore } from '@ruv.io/kimi-fann-core'
...
```typescript
import { KimiFannCore, Config } from '@ruv.io/kimi-fann-core'
...
// CommonJS
const { KimiFannCore } = require('@ruv.io/kimi-fann-core')
```
...
```typescript
import { KimiFannCore, KimiFannCoreError } from '@ruv.io/kimi-fann-core'
...
```typescript
import { KimiFannCore, Config, LogLevel } from '@ruv.io/kimi-fann-core'
...
cd ruv.io/packages/kimi-fann-core
...
- **NPM Package**: [@ruv.io/kimi-fann-core](https://www.npmjs.com/package/@ruv.io/kimi-fann-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [kimi-fann-core](https://crates.io/crates/kimi-fann-core)
- **Documentation**: [docs.ruv.io/kimi-fann-core](https://docs.ruv.io/kimi-fann-core)
...
![NPM](https://nodei.co/npm/@ruv.io/kimi-fann-core.png?downloads=true&downloadRank=true&stars=true)
