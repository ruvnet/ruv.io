# ⏰ @ruv.io/temporal-attractor-studio

> Temporal Attractor Studio - Real FTLE calculation and temporal dynamics prediction with VP-tree optimization

[![npm version](https://img.shields.io/npm/v/@ruv.io/temporal-attractor-studio.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/temporal-attractor-studio)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/temporal-attractor-studio.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/temporal-attractor-studio)
[![license](https://img.shields.io/npm/l/@ruv.io/temporal-attractor-studio.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/temporal-attractor-studio` is a high-performance Node.js native addon that provides TypeScript bindings for the [`temporal-attractor-studio`](https://crates.io/crates/temporal-attractor-studio) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/temporal-attractor-studio
```

### Using yarn

```bash
yarn add @ruv.io/temporal-attractor-studio
```

### Using pnpm

```bash
pnpm add @ruv.io/temporal-attractor-studio
```
...
- **Linux x64**: `@ruv.io/temporal-attractor-studio-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/temporal-attractor-studio-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/temporal-attractor-studio-darwin-x64`
- **macOS ARM64**: `@ruv.io/temporal-attractor-studio-darwin-arm64`
- **Windows x64**: `@ruv.io/temporal-attractor-studio-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/temporal-attractor-studio-wasm32` (fallback)
...
```typescript
import { TemporalAttractorStudio } from '@ruv.io/temporal-attractor-studio'
...
```typescript
import { TemporalAttractorStudio, Config } from '@ruv.io/temporal-attractor-studio'
...
// CommonJS
const { TemporalAttractorStudio } = require('@ruv.io/temporal-attractor-studio')
```
...
```typescript
import { TemporalAttractorStudio, TemporalAttractorStudioError } from '@ruv.io/temporal-attractor-studio'
...
```typescript
import { TemporalAttractorStudio, Config, LogLevel } from '@ruv.io/temporal-attractor-studio'
...
cd ruv.io/packages/temporal-attractor-studio
...
- **NPM Package**: [@ruv.io/temporal-attractor-studio](https://www.npmjs.com/package/@ruv.io/temporal-attractor-studio)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [temporal-attractor-studio](https://crates.io/crates/temporal-attractor-studio)
- **Documentation**: [docs.ruv.io/temporal-attractor-studio](https://docs.ruv.io/temporal-attractor-studio)
...
![NPM](https://nodei.co/npm/@ruv.io/temporal-attractor-studio.png?downloads=true&downloadRank=true&stars=true)
