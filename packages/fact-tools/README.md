...
[![npm version](https://img.shields.io/npm/v/@ruv.io/fact-tools.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/fact-tools)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/fact-tools.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/fact-tools)
[![license](https://img.shields.io/npm/l/@ruv.io/fact-tools.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/fact-tools` is a high-performance Node.js native addon that provides TypeScript bindings for the [`fact-tools`](https://crates.io/crates/fact-tools) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/fact-tools
```

### Using yarn

```bash
yarn add @ruv.io/fact-tools
```

### Using pnpm

```bash
pnpm add @ruv.io/fact-tools
```
...
- **Linux x64**: `@ruv.io/fact-tools-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/fact-tools-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/fact-tools-darwin-x64`
- **macOS ARM64**: `@ruv.io/fact-tools-darwin-arm64`
- **Windows x64**: `@ruv.io/fact-tools-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/fact-tools-wasm32` (fallback)
...
```typescript
import { FactTools } from '@ruv.io/fact-tools'
...
```typescript
import { FactTools, Config } from '@ruv.io/fact-tools'
...
// CommonJS
const { FactTools } = require('@ruv.io/fact-tools')
```
...
```typescript
import { FactTools, FactToolsError } from '@ruv.io/fact-tools'
...
```typescript
import { FactTools, Config, LogLevel } from '@ruv.io/fact-tools'
...
- **NPM Package**: [@ruv.io/fact-tools](https://www.npmjs.com/package/@ruv.io/fact-tools)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [fact-tools](https://crates.io/crates/fact-tools)
- **Documentation**: [docs.ruv.io/fact-tools](https://docs.ruv.io/fact-tools)
...
![NPM](https://nodei.co/npm/@ruv.io/fact-tools.png?downloads=true&downloadRank=true&stars=true)
