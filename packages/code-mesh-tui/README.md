# 🐝 @ruv.io/code-mesh-tui

> Interactive Terminal User Interface for the Code-Mesh distributed swarm intelligence system

[![npm version](https://img.shields.io/npm/v/@ruv.io/code-mesh-tui.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/code-mesh-tui)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/code-mesh-tui.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/code-mesh-tui)
[![license](https://img.shields.io/npm/l/@ruv.io/code-mesh-tui.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/code-mesh-tui` is a high-performance Node.js native addon that provides TypeScript bindings for the [`code-mesh-tui`](https://crates.io/crates/code-mesh-tui) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/code-mesh-tui
```

### Using yarn

```bash
yarn add @ruv.io/code-mesh-tui
```

### Using pnpm

```bash
pnpm add @ruv.io/code-mesh-tui
```
...
- **Linux x64**: `@ruv.io/code-mesh-tui-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/code-mesh-tui-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/code-mesh-tui-darwin-x64`
- **macOS ARM64**: `@ruv.io/code-mesh-tui-darwin-arm64`
- **Windows x64**: `@ruv.io/code-mesh-tui-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/code-mesh-tui-wasm32` (fallback)
...
```typescript
import { CodeMeshTui } from '@ruv.io/code-mesh-tui'
...
```typescript
import { CodeMeshTui, Config } from '@ruv.io/code-mesh-tui'
...
// CommonJS
const { CodeMeshTui } = require('@ruv.io/code-mesh-tui')
```
...
```typescript
import { CodeMeshTui, CodeMeshTuiError } from '@ruv.io/code-mesh-tui'
...
```typescript
import { CodeMeshTui, Config, LogLevel } from '@ruv.io/code-mesh-tui'
...
cd ruv.io/packages/code-mesh-tui
...
- **NPM Package**: [@ruv.io/code-mesh-tui](https://www.npmjs.com/package/@ruv.io/code-mesh-tui)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [code-mesh-tui](https://crates.io/crates/code-mesh-tui)
- **Documentation**: [docs.ruv.io/code-mesh-tui](https://docs.ruv.io/code-mesh-tui)
...
![NPM](https://nodei.co/npm/@ruv.io/code-mesh-tui.png?downloads=true&downloadRank=true&stars=true)
