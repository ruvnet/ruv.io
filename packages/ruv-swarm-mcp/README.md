# 🐝 @ruv.io/ruv-swarm-mcp

> Model Context Protocol (MCP) integration for RUV Swarm

[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-swarm-mcp.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-mcp)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-swarm-mcp.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-mcp)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-swarm-mcp.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-swarm-mcp` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-mcp`](https://crates.io/crates/ruv-swarm-mcp) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-swarm-mcp
```

### Using yarn

```bash
yarn add @ruv.io/ruv-swarm-mcp
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-swarm-mcp
```
...
- **Linux x64**: `@ruv.io/ruv-swarm-mcp-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-swarm-mcp-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-swarm-mcp-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-swarm-mcp-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-swarm-mcp-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-swarm-mcp-wasm32` (fallback)
...
```typescript
import { RuvSwarmMcp } from '@ruv.io/ruv-swarm-mcp'
...
```typescript
import { RuvSwarmMcp, Config } from '@ruv.io/ruv-swarm-mcp'
...
// CommonJS
const { RuvSwarmMcp } = require('@ruv.io/ruv-swarm-mcp')
```
...
```typescript
import { RuvSwarmMcp, RuvSwarmMcpError } from '@ruv.io/ruv-swarm-mcp'
...
```typescript
import { RuvSwarmMcp, Config, LogLevel } from '@ruv.io/ruv-swarm-mcp'
...
cd ruv.io/packages/ruv-swarm-mcp
...
- **NPM Package**: [@ruv.io/ruv-swarm-mcp](https://www.npmjs.com/package/@ruv.io/ruv-swarm-mcp)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-swarm-mcp](https://crates.io/crates/ruv-swarm-mcp)
- **Documentation**: [docs.ruv.io/ruv-swarm-mcp](https://docs.ruv.io/ruv-swarm-mcp)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-swarm-mcp.png?downloads=true&downloadRank=true&stars=true)
