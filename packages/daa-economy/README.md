...
[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-economy.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-economy)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-economy.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-economy)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-economy.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-economy` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-economy`](https://crates.io/crates/daa-economy) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-economy
```

### Using yarn

```bash
yarn add @ruv.io/daa-economy
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-economy
```
...
- **Linux x64**: `@ruv.io/daa-economy-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-economy-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-economy-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-economy-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-economy-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-economy-wasm32` (fallback)
...
```typescript
import { DaaEconomy } from '@ruv.io/daa-economy'
...
```typescript
import { DaaEconomy, Config } from '@ruv.io/daa-economy'
...
// CommonJS
const { DaaEconomy } = require('@ruv.io/daa-economy')
```
...
```typescript
import { DaaEconomy, DaaEconomyError } from '@ruv.io/daa-economy'
...
```typescript
import { DaaEconomy, Config, LogLevel } from '@ruv.io/daa-economy'
...
cd ruv.io/packages/daa-economy
...
- **NPM Package**: [@ruv.io/daa-economy](https://www.npmjs.com/package/@ruv.io/daa-economy)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-economy](https://crates.io/crates/daa-economy)
- **Documentation**: [docs.ruv.io/daa-economy](https://docs.ruv.io/daa-economy)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-economy.png?downloads=true&downloadRank=true&stars=true)
