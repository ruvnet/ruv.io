# 📦 @ruv.io/aimds-analysis

> Deep behavioral analysis layer for AIMDS with temporal neural verification

[![npm version](https://img.shields.io/npm/v/@ruv.io/aimds-analysis.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/aimds-analysis)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/aimds-analysis.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/aimds-analysis)
[![license](https://img.shields.io/npm/l/@ruv.io/aimds-analysis.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/aimds-analysis` is a high-performance Node.js native addon that provides TypeScript bindings for the [`aimds-analysis`](https://crates.io/crates/aimds-analysis) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/aimds-analysis
```

### Using yarn

```bash
yarn add @ruv.io/aimds-analysis
```

### Using pnpm

```bash
pnpm add @ruv.io/aimds-analysis
```
...
- **Linux x64**: `@ruv.io/aimds-analysis-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/aimds-analysis-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/aimds-analysis-darwin-x64`
- **macOS ARM64**: `@ruv.io/aimds-analysis-darwin-arm64`
- **Windows x64**: `@ruv.io/aimds-analysis-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/aimds-analysis-wasm32` (fallback)
...
```typescript
import { AimdsAnalysis } from '@ruv.io/aimds-analysis'
...
```typescript
import { AimdsAnalysis, Config } from '@ruv.io/aimds-analysis'
...
// CommonJS
const { AimdsAnalysis } = require('@ruv.io/aimds-analysis')
```
...
```typescript
import { AimdsAnalysis, AimdsAnalysisError } from '@ruv.io/aimds-analysis'
...
```typescript
import { AimdsAnalysis, Config, LogLevel } from '@ruv.io/aimds-analysis'
...
cd ruv.io/packages/aimds-analysis
...
- **NPM Package**: [@ruv.io/aimds-analysis](https://www.npmjs.com/package/@ruv.io/aimds-analysis)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [aimds-analysis](https://crates.io/crates/aimds-analysis)
- **Documentation**: [docs.ruv.io/aimds-analysis](https://docs.ruv.io/aimds-analysis)
...
![NPM](https://nodei.co/npm/@ruv.io/aimds-analysis.png?downloads=true&downloadRank=true&stars=true)
