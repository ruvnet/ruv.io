# 🧠 @ruv.io/neuro-divergent-registry

> Model factory and registry system for dynamic neural network model creation and management

[![npm version](https://img.shields.io/npm/v/@ruv.io/neuro-divergent-registry.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent-registry)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/neuro-divergent-registry.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent-registry)
[![license](https://img.shields.io/npm/l/@ruv.io/neuro-divergent-registry.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/neuro-divergent-registry` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent-registry`](https://crates.io/crates/neuro-divergent-registry) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/neuro-divergent-registry
```

### Using yarn

```bash
yarn add @ruv.io/neuro-divergent-registry
```

### Using pnpm

```bash
pnpm add @ruv.io/neuro-divergent-registry
```
...
- **Linux x64**: `@ruv.io/neuro-divergent-registry-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/neuro-divergent-registry-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/neuro-divergent-registry-darwin-x64`
- **macOS ARM64**: `@ruv.io/neuro-divergent-registry-darwin-arm64`
- **Windows x64**: `@ruv.io/neuro-divergent-registry-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/neuro-divergent-registry-wasm32` (fallback)
...
```typescript
import { NeuroDivergentRegistry } from '@ruv.io/neuro-divergent-registry'
...
```typescript
import { NeuroDivergentRegistry, Config } from '@ruv.io/neuro-divergent-registry'
...
// CommonJS
const { NeuroDivergentRegistry } = require('@ruv.io/neuro-divergent-registry')
```
...
```typescript
import { NeuroDivergentRegistry, NeuroDivergentRegistryError } from '@ruv.io/neuro-divergent-registry'
...
```typescript
import { NeuroDivergentRegistry, Config, LogLevel } from '@ruv.io/neuro-divergent-registry'
...
cd ruv.io/packages/neuro-divergent-registry
...
- **NPM Package**: [@ruv.io/neuro-divergent-registry](https://www.npmjs.com/package/@ruv.io/neuro-divergent-registry)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [neuro-divergent-registry](https://crates.io/crates/neuro-divergent-registry)
- **Documentation**: [docs.ruv.io/neuro-divergent-registry](https://docs.ruv.io/neuro-divergent-registry)
...
![NPM](https://nodei.co/npm/@ruv.io/neuro-divergent-registry.png?downloads=true&downloadRank=true&stars=true)
