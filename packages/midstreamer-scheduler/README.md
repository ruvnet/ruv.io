# ⏰ @ruv.io/midstreamer-scheduler

> Ultra-low-latency real-time task scheduler

[![npm version](https://img.shields.io/npm/v/@ruv.io/midstreamer-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-scheduler)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/midstreamer-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-scheduler)
[![license](https://img.shields.io/npm/l/@ruv.io/midstreamer-scheduler.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/midstreamer-scheduler` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-scheduler`](https://crates.io/crates/midstreamer-scheduler) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/midstreamer-scheduler
```

### Using yarn

```bash
yarn add @ruv.io/midstreamer-scheduler
```

### Using pnpm

```bash
pnpm add @ruv.io/midstreamer-scheduler
```
...
- **Linux x64**: `@ruv.io/midstreamer-scheduler-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/midstreamer-scheduler-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/midstreamer-scheduler-darwin-x64`
- **macOS ARM64**: `@ruv.io/midstreamer-scheduler-darwin-arm64`
- **Windows x64**: `@ruv.io/midstreamer-scheduler-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/midstreamer-scheduler-wasm32` (fallback)
...
```typescript
import { MidstreamerScheduler } from '@ruv.io/midstreamer-scheduler'
...
```typescript
import { MidstreamerScheduler, Config } from '@ruv.io/midstreamer-scheduler'
...
// CommonJS
const { MidstreamerScheduler } = require('@ruv.io/midstreamer-scheduler')
```
...
```typescript
import { MidstreamerScheduler, MidstreamerSchedulerError } from '@ruv.io/midstreamer-scheduler'
...
```typescript
import { MidstreamerScheduler, Config, LogLevel } from '@ruv.io/midstreamer-scheduler'
...
cd ruv.io/packages/midstreamer-scheduler
...
- **NPM Package**: [@ruv.io/midstreamer-scheduler](https://www.npmjs.com/package/@ruv.io/midstreamer-scheduler)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [midstreamer-scheduler](https://crates.io/crates/midstreamer-scheduler)
- **Documentation**: [docs.ruv.io/midstreamer-scheduler](https://docs.ruv.io/midstreamer-scheduler)
...
![NPM](https://nodei.co/npm/@ruv.io/midstreamer-scheduler.png?downloads=true&downloadRank=true&stars=true)
