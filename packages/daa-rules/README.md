...
[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-rules.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-rules)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-rules.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-rules)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-rules.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-rules` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-rules`](https://crates.io/crates/daa-rules) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-rules
```

### Using yarn

```bash
yarn add @ruv.io/daa-rules
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-rules
```
...
- **Linux x64**: `@ruv.io/daa-rules-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-rules-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-rules-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-rules-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-rules-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-rules-wasm32` (fallback)
...
```typescript
import { DaaRules } from '@ruv.io/daa-rules'
...
```typescript
import { DaaRules, Config } from '@ruv.io/daa-rules'
...
// CommonJS
const { DaaRules } = require('@ruv.io/daa-rules')
```
...
```typescript
import { DaaRules, DaaRulesError } from '@ruv.io/daa-rules'
...
```typescript
import { DaaRules, Config, LogLevel } from '@ruv.io/daa-rules'
...
- **NPM Package**: [@ruv.io/daa-rules](https://www.npmjs.com/package/@ruv.io/daa-rules)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-rules](https://crates.io/crates/daa-rules)
- **Documentation**: [docs.ruv.io/daa-rules](https://docs.ruv.io/daa-rules)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-rules.png?downloads=true&downloadRank=true&stars=true)
