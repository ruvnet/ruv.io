# 📦 @ruv.io/aimds-response

> Adaptive response layer with meta-learning for AIMDS threat mitigation

[![npm version](https://img.shields.io/npm/v/@ruv.io/aimds-response.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/aimds-response)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/aimds-response.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/aimds-response)
[![license](https://img.shields.io/npm/l/@ruv.io/aimds-response.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/aimds-response` is a high-performance Node.js native addon that provides TypeScript bindings for the [`aimds-response`](https://crates.io/crates/aimds-response) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/aimds-response
```

### Using yarn

```bash
yarn add @ruv.io/aimds-response
```

### Using pnpm

```bash
pnpm add @ruv.io/aimds-response
```
...
- **Linux x64**: `@ruv.io/aimds-response-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/aimds-response-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/aimds-response-darwin-x64`
- **macOS ARM64**: `@ruv.io/aimds-response-darwin-arm64`
- **Windows x64**: `@ruv.io/aimds-response-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/aimds-response-wasm32` (fallback)
...
```typescript
import { AimdsResponse } from '@ruv.io/aimds-response'
...
```typescript
import { AimdsResponse, Config } from '@ruv.io/aimds-response'
...
// CommonJS
const { AimdsResponse } = require('@ruv.io/aimds-response')
```
...
```typescript
import { AimdsResponse, AimdsResponseError } from '@ruv.io/aimds-response'
...
```typescript
import { AimdsResponse, Config, LogLevel } from '@ruv.io/aimds-response'
...
cd ruv.io/packages/aimds-response
...
- **NPM Package**: [@ruv.io/aimds-response](https://www.npmjs.com/package/@ruv.io/aimds-response)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [aimds-response](https://crates.io/crates/aimds-response)
- **Documentation**: [docs.ruv.io/aimds-response](https://docs.ruv.io/aimds-response)
...
![NPM](https://nodei.co/npm/@ruv.io/aimds-response.png?downloads=true&downloadRank=true&stars=true)
