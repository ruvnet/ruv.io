...
[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-swarm-ml.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-ml)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-swarm-ml.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-ml)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-swarm-ml.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-swarm-ml` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-ml`](https://crates.io/crates/ruv-swarm-ml) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-swarm-ml
```

### Using yarn

```bash
yarn add @ruv.io/ruv-swarm-ml
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-swarm-ml
```
...
- **Linux x64**: `@ruv.io/ruv-swarm-ml-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-swarm-ml-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-swarm-ml-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-swarm-ml-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-swarm-ml-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-swarm-ml-wasm32` (fallback)
...
```typescript
import { RuvSwarmMl } from '@ruv.io/ruv-swarm-ml'
...
```typescript
import { RuvSwarmMl, Config } from '@ruv.io/ruv-swarm-ml'
...
// CommonJS
const { RuvSwarmMl } = require('@ruv.io/ruv-swarm-ml')
```
...
```typescript
import { RuvSwarmMl, RuvSwarmMlError } from '@ruv.io/ruv-swarm-ml'
...
```typescript
import { RuvSwarmMl, Config, LogLevel } from '@ruv.io/ruv-swarm-ml'
...
cd ruv.io/packages/ruv-swarm-ml
...
- **NPM Package**: [@ruv.io/ruv-swarm-ml](https://www.npmjs.com/package/@ruv.io/ruv-swarm-ml)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-swarm-ml](https://crates.io/crates/ruv-swarm-ml)
- **Documentation**: [docs.ruv.io/ruv-swarm-ml](https://docs.ruv.io/ruv-swarm-ml)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-swarm-ml.png?downloads=true&downloadRank=true&stars=true)
