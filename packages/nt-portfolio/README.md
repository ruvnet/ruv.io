...
[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-portfolio.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-portfolio)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-portfolio.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-portfolio)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-portfolio.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-portfolio` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-portfolio`](https://crates.io/crates/nt-portfolio) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-portfolio
```

### Using yarn

```bash
yarn add @ruv.io/nt-portfolio
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-portfolio
```
...
- **Linux x64**: `@ruv.io/nt-portfolio-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-portfolio-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-portfolio-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-portfolio-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-portfolio-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-portfolio-wasm32` (fallback)
...
```typescript
import { NtPortfolio } from '@ruv.io/nt-portfolio'
...
```typescript
import { NtPortfolio, Config } from '@ruv.io/nt-portfolio'
...
// CommonJS
const { NtPortfolio } = require('@ruv.io/nt-portfolio')
```
...
```typescript
import { NtPortfolio, NtPortfolioError } from '@ruv.io/nt-portfolio'
...
```typescript
import { NtPortfolio, Config, LogLevel } from '@ruv.io/nt-portfolio'
...
cd ruv.io/packages/nt-portfolio
...
- **NPM Package**: [@ruv.io/nt-portfolio](https://www.npmjs.com/package/@ruv.io/nt-portfolio)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-portfolio](https://crates.io/crates/nt-portfolio)
- **Documentation**: [docs.ruv.io/nt-portfolio](https://docs.ruv.io/nt-portfolio)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-portfolio.png?downloads=true&downloadRank=true&stars=true)
