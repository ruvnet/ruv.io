# 📦 @ruv.io/daa-prime-coordinator

> Governance and coordination layer using DAA for Prime distributed ML

[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-prime-coordinator.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-prime-coordinator)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-prime-coordinator.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-prime-coordinator)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-prime-coordinator.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-prime-coordinator` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-prime-coordinator`](https://crates.io/crates/daa-prime-coordinator) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-prime-coordinator
```

### Using yarn

```bash
yarn add @ruv.io/daa-prime-coordinator
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-prime-coordinator
```
...
- **Linux x64**: `@ruv.io/daa-prime-coordinator-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-prime-coordinator-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-prime-coordinator-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-prime-coordinator-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-prime-coordinator-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-prime-coordinator-wasm32` (fallback)
...
```typescript
import { DaaPrimeCoordinator } from '@ruv.io/daa-prime-coordinator'
...
```typescript
import { DaaPrimeCoordinator, Config } from '@ruv.io/daa-prime-coordinator'
...
// CommonJS
const { DaaPrimeCoordinator } = require('@ruv.io/daa-prime-coordinator')
```
...
```typescript
import { DaaPrimeCoordinator, DaaPrimeCoordinatorError } from '@ruv.io/daa-prime-coordinator'
...
```typescript
import { DaaPrimeCoordinator, Config, LogLevel } from '@ruv.io/daa-prime-coordinator'
...
cd ruv.io/packages/daa-prime-coordinator
...
- **NPM Package**: [@ruv.io/daa-prime-coordinator](https://www.npmjs.com/package/@ruv.io/daa-prime-coordinator)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-prime-coordinator](https://crates.io/crates/daa-prime-coordinator)
- **Documentation**: [docs.ruv.io/daa-prime-coordinator](https://docs.ruv.io/daa-prime-coordinator)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-prime-coordinator.png?downloads=true&downloadRank=true&stars=true)
