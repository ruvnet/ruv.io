# ⚛️ @ruv.io/qudag-vault-core

> Quantum-resistant password vault library with post-quantum cryptography

[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag-vault-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-vault-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag-vault-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-vault-core)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag-vault-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qudag-vault-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-vault-core`](https://crates.io/crates/qudag-vault-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qudag-vault-core
```

### Using yarn

```bash
yarn add @ruv.io/qudag-vault-core
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag-vault-core
```
...
- **Linux x64**: `@ruv.io/qudag-vault-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-vault-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-vault-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-vault-core-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-vault-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-vault-core-wasm32` (fallback)
...
```typescript
import { QudagVaultCore } from '@ruv.io/qudag-vault-core'
...
```typescript
import { QudagVaultCore, Config } from '@ruv.io/qudag-vault-core'
...
// CommonJS
const { QudagVaultCore } = require('@ruv.io/qudag-vault-core')
```
...
```typescript
import { QudagVaultCore, QudagVaultCoreError } from '@ruv.io/qudag-vault-core'
...
```typescript
import { QudagVaultCore, Config, LogLevel } from '@ruv.io/qudag-vault-core'
...
cd ruv.io/packages/qudag-vault-core
...
- **NPM Package**: [@ruv.io/qudag-vault-core](https://www.npmjs.com/package/@ruv.io/qudag-vault-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag-vault-core](https://crates.io/crates/qudag-vault-core)
- **Documentation**: [docs.ruv.io/qudag-vault-core](https://docs.ruv.io/qudag-vault-core)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag-vault-core.png?downloads=true&downloadRank=true&stars=true)
