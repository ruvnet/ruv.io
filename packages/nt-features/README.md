...
[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-features.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-features)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-features.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-features)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-features.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-features` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-features`](https://crates.io/crates/nt-features) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-features
```

### Using yarn

```bash
yarn add @ruv.io/nt-features
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-features
```
...
- **Linux x64**: `@ruv.io/nt-features-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-features-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-features-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-features-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-features-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-features-wasm32` (fallback)
...
```typescript
import { NtFeatures } from '@ruv.io/nt-features'
...
```typescript
import { NtFeatures, Config } from '@ruv.io/nt-features'
...
// CommonJS
const { NtFeatures } = require('@ruv.io/nt-features')
```
...
```typescript
import { NtFeatures, NtFeaturesError } from '@ruv.io/nt-features'
...
```typescript
import { NtFeatures, Config, LogLevel } from '@ruv.io/nt-features'
...
cd ruv.io/packages/nt-features
...
- **NPM Package**: [@ruv.io/nt-features](https://www.npmjs.com/package/@ruv.io/nt-features)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-features](https://crates.io/crates/nt-features)
- **Documentation**: [docs.ruv.io/nt-features](https://docs.ruv.io/nt-features)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-features.png?downloads=true&downloadRank=true&stars=true)
