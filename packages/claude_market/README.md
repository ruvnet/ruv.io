# 🌐 @ruv.io/claude_market

> P2P marketplace for trading Claude API tokens with escrow and reputation

[![npm version](https://img.shields.io/npm/v/@ruv.io/claude_market.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/claude_market)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/claude_market.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/claude_market)
[![license](https://img.shields.io/npm/l/@ruv.io/claude_market.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/claude_market` is a high-performance Node.js native addon that provides TypeScript bindings for the [`claude_market`](https://crates.io/crates/claude_market) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/claude_market
```

### Using yarn

```bash
yarn add @ruv.io/claude_market
```

### Using pnpm

```bash
pnpm add @ruv.io/claude_market
```
...
- **Linux x64**: `@ruv.io/claude_market-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/claude_market-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/claude_market-darwin-x64`
- **macOS ARM64**: `@ruv.io/claude_market-darwin-arm64`
- **Windows x64**: `@ruv.io/claude_market-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/claude_market-wasm32` (fallback)
...
```typescript
import { Claude_market } from '@ruv.io/claude_market'
...
```typescript
import { Claude_market, Config } from '@ruv.io/claude_market'
...
// CommonJS
const { Claude_market } = require('@ruv.io/claude_market')
```
...
```typescript
import { Claude_market, Claude_marketError } from '@ruv.io/claude_market'
...
```typescript
import { Claude_market, Config, LogLevel } from '@ruv.io/claude_market'
...
cd ruv.io/packages/claude_market
...
- **NPM Package**: [@ruv.io/claude_market](https://www.npmjs.com/package/@ruv.io/claude_market)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [claude_market](https://crates.io/crates/claude_market)
- **Documentation**: [docs.ruv.io/claude_market](https://docs.ruv.io/claude_market)
...
![NPM](https://nodei.co/npm/@ruv.io/claude_market.png?downloads=true&downloadRank=true&stars=true)
