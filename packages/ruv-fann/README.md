...
[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-fann.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-fann)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-fann.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-fann)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-fann.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-fann` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-fann`](https://crates.io/crates/ruv-fann) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-fann
```

### Using yarn

```bash
yarn add @ruv.io/ruv-fann
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-fann
```
...
- **Linux x64**: `@ruv.io/ruv-fann-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-fann-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-fann-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-fann-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-fann-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-fann-wasm32` (fallback)
...
```typescript
import { RuvFann } from '@ruv.io/ruv-fann'
...
```typescript
import { RuvFann, Config } from '@ruv.io/ruv-fann'
...
// CommonJS
const { RuvFann } = require('@ruv.io/ruv-fann')
```
...
```typescript
import { RuvFann, RuvFannError } from '@ruv.io/ruv-fann'
...
```typescript
import { RuvFann, Config, LogLevel } from '@ruv.io/ruv-fann'
...
- **NPM Package**: [@ruv.io/ruv-fann](https://www.npmjs.com/package/@ruv.io/ruv-fann)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-fann](https://crates.io/crates/ruv-fann)
- **Documentation**: [docs.ruv.io/ruv-fann](https://docs.ruv.io/ruv-fann)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-fann.png?downloads=true&downloadRank=true&stars=true)
