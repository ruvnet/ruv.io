# 🐝 @ruv.io/ruv-swarm-persistence

> Persistence layer with SQLite and ORM for RUV-Swarm

[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-swarm-persistence.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-persistence)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-swarm-persistence.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-persistence)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-swarm-persistence.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-swarm-persistence` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-persistence`](https://crates.io/crates/ruv-swarm-persistence) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-swarm-persistence
```

### Using yarn

```bash
yarn add @ruv.io/ruv-swarm-persistence
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-swarm-persistence
```
...
- **Linux x64**: `@ruv.io/ruv-swarm-persistence-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-swarm-persistence-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-swarm-persistence-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-swarm-persistence-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-swarm-persistence-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-swarm-persistence-wasm32` (fallback)
...
```typescript
import { RuvSwarmPersistence } from '@ruv.io/ruv-swarm-persistence'
...
```typescript
import { RuvSwarmPersistence, Config } from '@ruv.io/ruv-swarm-persistence'
...
// CommonJS
const { RuvSwarmPersistence } = require('@ruv.io/ruv-swarm-persistence')
```
...
```typescript
import { RuvSwarmPersistence, RuvSwarmPersistenceError } from '@ruv.io/ruv-swarm-persistence'
...
```typescript
import { RuvSwarmPersistence, Config, LogLevel } from '@ruv.io/ruv-swarm-persistence'
...
cd ruv.io/packages/ruv-swarm-persistence
...
- **NPM Package**: [@ruv.io/ruv-swarm-persistence](https://www.npmjs.com/package/@ruv.io/ruv-swarm-persistence)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-swarm-persistence](https://crates.io/crates/ruv-swarm-persistence)
- **Documentation**: [docs.ruv.io/ruv-swarm-persistence](https://docs.ruv.io/ruv-swarm-persistence)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-swarm-persistence.png?downloads=true&downloadRank=true&stars=true)
