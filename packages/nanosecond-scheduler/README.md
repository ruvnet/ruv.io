# ⏰ @ruv.io/nanosecond-scheduler

> Ultra-low latency nanosecond-precision scheduler for temporal consciousness applications

[![npm version](https://img.shields.io/npm/v/@ruv.io/nanosecond-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nanosecond-scheduler)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nanosecond-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nanosecond-scheduler)
[![license](https://img.shields.io/npm/l/@ruv.io/nanosecond-scheduler.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nanosecond-scheduler` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nanosecond-scheduler`](https://crates.io/crates/nanosecond-scheduler) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nanosecond-scheduler
```

### Using yarn

```bash
yarn add @ruv.io/nanosecond-scheduler
```

### Using pnpm

```bash
pnpm add @ruv.io/nanosecond-scheduler
```
...
- **Linux x64**: `@ruv.io/nanosecond-scheduler-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nanosecond-scheduler-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nanosecond-scheduler-darwin-x64`
- **macOS ARM64**: `@ruv.io/nanosecond-scheduler-darwin-arm64`
- **Windows x64**: `@ruv.io/nanosecond-scheduler-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nanosecond-scheduler-wasm32` (fallback)
...
```typescript
import { NanosecondScheduler } from '@ruv.io/nanosecond-scheduler'
...
```typescript
import { NanosecondScheduler, Config } from '@ruv.io/nanosecond-scheduler'
...
// CommonJS
const { NanosecondScheduler } = require('@ruv.io/nanosecond-scheduler')
```
...
```typescript
import { NanosecondScheduler, NanosecondSchedulerError } from '@ruv.io/nanosecond-scheduler'
...
```typescript
import { NanosecondScheduler, Config, LogLevel } from '@ruv.io/nanosecond-scheduler'
...
cd ruv.io/packages/nanosecond-scheduler
...
- **NPM Package**: [@ruv.io/nanosecond-scheduler](https://www.npmjs.com/package/@ruv.io/nanosecond-scheduler)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nanosecond-scheduler](https://crates.io/crates/nanosecond-scheduler)
- **Documentation**: [docs.ruv.io/nanosecond-scheduler](https://docs.ruv.io/nanosecond-scheduler)
...
![NPM](https://nodei.co/npm/@ruv.io/nanosecond-scheduler.png?downloads=true&downloadRank=true&stars=true)
