# ⚛️ @ruv.io/qvm-scheduler

> High-performance quantum circuit scheduler for multi-job quantum computing with OpenQASM 3

[![npm version](https://img.shields.io/npm/v/@ruv.io/qvm-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qvm-scheduler)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qvm-scheduler.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qvm-scheduler)
[![license](https://img.shields.io/npm/l/@ruv.io/qvm-scheduler.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qvm-scheduler` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qvm-scheduler`](https://crates.io/crates/qvm-scheduler) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qvm-scheduler
```

### Using yarn

```bash
yarn add @ruv.io/qvm-scheduler
```

### Using pnpm

```bash
pnpm add @ruv.io/qvm-scheduler
```
...
- **Linux x64**: `@ruv.io/qvm-scheduler-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qvm-scheduler-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qvm-scheduler-darwin-x64`
- **macOS ARM64**: `@ruv.io/qvm-scheduler-darwin-arm64`
- **Windows x64**: `@ruv.io/qvm-scheduler-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qvm-scheduler-wasm32` (fallback)
...
```typescript
import { QvmScheduler } from '@ruv.io/qvm-scheduler'
...
```typescript
import { QvmScheduler, Config } from '@ruv.io/qvm-scheduler'
...
// CommonJS
const { QvmScheduler } = require('@ruv.io/qvm-scheduler')
```
...
```typescript
import { QvmScheduler, QvmSchedulerError } from '@ruv.io/qvm-scheduler'
...
```typescript
import { QvmScheduler, Config, LogLevel } from '@ruv.io/qvm-scheduler'
...
cd ruv.io/packages/qvm-scheduler
...
- **NPM Package**: [@ruv.io/qvm-scheduler](https://www.npmjs.com/package/@ruv.io/qvm-scheduler)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qvm-scheduler](https://crates.io/crates/qvm-scheduler)
- **Documentation**: [docs.ruv.io/qvm-scheduler](https://docs.ruv.io/qvm-scheduler)
...
![NPM](https://nodei.co/npm/@ruv.io/qvm-scheduler.png?downloads=true&downloadRank=true&stars=true)
