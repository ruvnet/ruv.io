...
[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-cli)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-cli)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag-cli.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qudag-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-cli`](https://crates.io/crates/qudag-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qudag-cli
```

### Using yarn

```bash
yarn add @ruv.io/qudag-cli
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag-cli
```
...
- **Linux x64**: `@ruv.io/qudag-cli-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-cli-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-cli-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-cli-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-cli-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-cli-wasm32` (fallback)
...
```typescript
import { QudagCli } from '@ruv.io/qudag-cli'
...
```typescript
import { QudagCli, Config } from '@ruv.io/qudag-cli'
...
// CommonJS
const { QudagCli } = require('@ruv.io/qudag-cli')
```
...
```typescript
import { QudagCli, QudagCliError } from '@ruv.io/qudag-cli'
...
```typescript
import { QudagCli, Config, LogLevel } from '@ruv.io/qudag-cli'
...
- **NPM Package**: [@ruv.io/qudag-cli](https://www.npmjs.com/package/@ruv.io/qudag-cli)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag-cli](https://crates.io/crates/qudag-cli)
- **Documentation**: [docs.ruv.io/qudag-cli](https://docs.ruv.io/qudag-cli)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag-cli.png?downloads=true&downloadRank=true&stars=true)
