# 🧠 @ruv.io/micro_routing

> Dynamic routing and context management for micro-neural networks

[![npm version](https://img.shields.io/npm/v/@ruv.io/micro_routing.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_routing)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/micro_routing.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_routing)
[![license](https://img.shields.io/npm/l/@ruv.io/micro_routing.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/micro_routing` is a high-performance Node.js native addon that provides TypeScript bindings for the [`micro_routing`](https://crates.io/crates/micro_routing) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/micro_routing
```

### Using yarn

```bash
yarn add @ruv.io/micro_routing
```

### Using pnpm

```bash
pnpm add @ruv.io/micro_routing
```
...
- **Linux x64**: `@ruv.io/micro_routing-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/micro_routing-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/micro_routing-darwin-x64`
- **macOS ARM64**: `@ruv.io/micro_routing-darwin-arm64`
- **Windows x64**: `@ruv.io/micro_routing-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/micro_routing-wasm32` (fallback)
...
```typescript
import { Micro_routing } from '@ruv.io/micro_routing'
...
```typescript
import { Micro_routing, Config } from '@ruv.io/micro_routing'
...
// CommonJS
const { Micro_routing } = require('@ruv.io/micro_routing')
```
...
```typescript
import { Micro_routing, Micro_routingError } from '@ruv.io/micro_routing'
...
```typescript
import { Micro_routing, Config, LogLevel } from '@ruv.io/micro_routing'
...
cd ruv.io/packages/micro_routing
...
- **NPM Package**: [@ruv.io/micro_routing](https://www.npmjs.com/package/@ruv.io/micro_routing)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [micro_routing](https://crates.io/crates/micro_routing)
- **Documentation**: [docs.ruv.io/micro_routing](https://docs.ruv.io/micro_routing)
...
![NPM](https://nodei.co/npm/@ruv.io/micro_routing.png?downloads=true&downloadRank=true&stars=true)
