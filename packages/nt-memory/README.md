...
[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-memory.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-memory)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-memory.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-memory)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-memory.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-memory` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-memory`](https://crates.io/crates/nt-memory) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-memory
```

### Using yarn

```bash
yarn add @ruv.io/nt-memory
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-memory
```
...
- **Linux x64**: `@ruv.io/nt-memory-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-memory-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-memory-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-memory-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-memory-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-memory-wasm32` (fallback)
...
```typescript
import { NtMemory } from '@ruv.io/nt-memory'
...
```typescript
import { NtMemory, Config } from '@ruv.io/nt-memory'
...
// CommonJS
const { NtMemory } = require('@ruv.io/nt-memory')
```
...
```typescript
import { NtMemory, NtMemoryError } from '@ruv.io/nt-memory'
...
```typescript
import { NtMemory, Config, LogLevel } from '@ruv.io/nt-memory'
...
- **NPM Package**: [@ruv.io/nt-memory](https://www.npmjs.com/package/@ruv.io/nt-memory)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-memory](https://crates.io/crates/nt-memory)
- **Documentation**: [docs.ruv.io/nt-memory](https://docs.ruv.io/nt-memory)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-memory.png?downloads=true&downloadRank=true&stars=true)
