# ⚛️ @ruv.io/qudag-exchange-standalone-cli

> Standalone command-line interface for QuDAG Exchange with rUv tokens

[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag-exchange-standalone-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-exchange-standalone-cli)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag-exchange-standalone-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-exchange-standalone-cli)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag-exchange-standalone-cli.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
```bash
npm install @ruv.io/qudag-exchange-standalone-cli
```

### Using yarn

```bash
yarn add @ruv.io/qudag-exchange-standalone-cli
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag-exchange-standalone-cli
```
...
- **Linux x64**: `@ruv.io/qudag-exchange-standalone-cli-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-exchange-standalone-cli-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-exchange-standalone-cli-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-exchange-standalone-cli-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-exchange-standalone-cli-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-exchange-standalone-cli-wasm32` (fallback)
...
```typescript
import { QudagExchangeStandaloneCli } from '@ruv.io/qudag-exchange-standalone-cli'
...
```typescript
import { QudagExchangeStandaloneCli, Config } from '@ruv.io/qudag-exchange-standalone-cli'
...
// CommonJS
const { QudagExchangeStandaloneCli } = require('@ruv.io/qudag-exchange-standalone-cli')
```
...
```typescript
import { QudagExchangeStandaloneCli, QudagExchangeStandaloneCliError } from '@ruv.io/qudag-exchange-standalone-cli'
...
```typescript
import { QudagExchangeStandaloneCli, Config, LogLevel } from '@ruv.io/qudag-exchange-standalone-cli'
...
cd ruv.io/packages/qudag-exchange-standalone-cli
...
- **NPM Package**: [@ruv.io/qudag-exchange-standalone-cli](https://www.npmjs.com/package/@ruv.io/qudag-exchange-standalone-cli)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag-exchange-standalone-cli](https://crates.io/crates/qudag-exchange-standalone-cli)
- **Documentation**: [docs.ruv.io/qudag-exchange-standalone-cli](https://docs.ruv.io/qudag-exchange-standalone-cli)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag-exchange-standalone-cli.png?downloads=true&downloadRank=true&stars=true)
