# 📦 @ruv.io/synaptic-mesh-cli

> CLI library for Synaptic Neural Mesh - complete integration with Synaptic Market

[![npm version](https://img.shields.io/npm/v/@ruv.io/synaptic-mesh-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/synaptic-mesh-cli)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/synaptic-mesh-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/synaptic-mesh-cli)
[![license](https://img.shields.io/npm/l/@ruv.io/synaptic-mesh-cli.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/synaptic-mesh-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`synaptic-mesh-cli`](https://crates.io/crates/synaptic-mesh-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/synaptic-mesh-cli
```

### Using yarn

```bash
yarn add @ruv.io/synaptic-mesh-cli
```

### Using pnpm

```bash
pnpm add @ruv.io/synaptic-mesh-cli
```
...
- **Linux x64**: `@ruv.io/synaptic-mesh-cli-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/synaptic-mesh-cli-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/synaptic-mesh-cli-darwin-x64`
- **macOS ARM64**: `@ruv.io/synaptic-mesh-cli-darwin-arm64`
- **Windows x64**: `@ruv.io/synaptic-mesh-cli-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/synaptic-mesh-cli-wasm32` (fallback)
...
```typescript
import { SynapticMeshCli } from '@ruv.io/synaptic-mesh-cli'
...
```typescript
import { SynapticMeshCli, Config } from '@ruv.io/synaptic-mesh-cli'
...
// CommonJS
const { SynapticMeshCli } = require('@ruv.io/synaptic-mesh-cli')
```
...
```typescript
import { SynapticMeshCli, SynapticMeshCliError } from '@ruv.io/synaptic-mesh-cli'
...
```typescript
import { SynapticMeshCli, Config, LogLevel } from '@ruv.io/synaptic-mesh-cli'
...
cd ruv.io/packages/synaptic-mesh-cli
...
- **NPM Package**: [@ruv.io/synaptic-mesh-cli](https://www.npmjs.com/package/@ruv.io/synaptic-mesh-cli)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [synaptic-mesh-cli](https://crates.io/crates/synaptic-mesh-cli)
- **Documentation**: [docs.ruv.io/synaptic-mesh-cli](https://docs.ruv.io/synaptic-mesh-cli)
...
![NPM](https://nodei.co/npm/@ruv.io/synaptic-mesh-cli.png?downloads=true&downloadRank=true&stars=true)
