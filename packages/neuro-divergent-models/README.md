# 🧠 @ruv.io/neuro-divergent-models

> Neural forecasting models implemented using ruv-FANN for time series forecasting

[![npm version](https://img.shields.io/npm/v/@ruv.io/neuro-divergent-models.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent-models)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/neuro-divergent-models.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent-models)
[![license](https://img.shields.io/npm/l/@ruv.io/neuro-divergent-models.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/neuro-divergent-models` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent-models`](https://crates.io/crates/neuro-divergent-models) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/neuro-divergent-models
```

### Using yarn

```bash
yarn add @ruv.io/neuro-divergent-models
```

### Using pnpm

```bash
pnpm add @ruv.io/neuro-divergent-models
```
...
- **Linux x64**: `@ruv.io/neuro-divergent-models-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/neuro-divergent-models-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/neuro-divergent-models-darwin-x64`
- **macOS ARM64**: `@ruv.io/neuro-divergent-models-darwin-arm64`
- **Windows x64**: `@ruv.io/neuro-divergent-models-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/neuro-divergent-models-wasm32` (fallback)
...
```typescript
import { NeuroDivergentModels } from '@ruv.io/neuro-divergent-models'
...
```typescript
import { NeuroDivergentModels, Config } from '@ruv.io/neuro-divergent-models'
...
// CommonJS
const { NeuroDivergentModels } = require('@ruv.io/neuro-divergent-models')
```
...
```typescript
import { NeuroDivergentModels, NeuroDivergentModelsError } from '@ruv.io/neuro-divergent-models'
...
```typescript
import { NeuroDivergentModels, Config, LogLevel } from '@ruv.io/neuro-divergent-models'
...
cd ruv.io/packages/neuro-divergent-models
...
- **NPM Package**: [@ruv.io/neuro-divergent-models](https://www.npmjs.com/package/@ruv.io/neuro-divergent-models)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [neuro-divergent-models](https://crates.io/crates/neuro-divergent-models)
- **Documentation**: [docs.ruv.io/neuro-divergent-models](https://docs.ruv.io/neuro-divergent-models)
...
![NPM](https://nodei.co/npm/@ruv.io/neuro-divergent-models.png?downloads=true&downloadRank=true&stars=true)
