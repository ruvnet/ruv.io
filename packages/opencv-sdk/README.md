...
[![npm version](https://img.shields.io/npm/v/@ruv.io/opencv-sdk.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/opencv-sdk)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/opencv-sdk.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/opencv-sdk)
[![license](https://img.shields.io/npm/l/@ruv.io/opencv-sdk.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
```bash
npm install @ruv.io/opencv-sdk
```

### Using yarn

```bash
yarn add @ruv.io/opencv-sdk
```

### Using pnpm

```bash
pnpm add @ruv.io/opencv-sdk
```
...
- **Linux x64**: `@ruv.io/opencv-sdk-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/opencv-sdk-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/opencv-sdk-darwin-x64`
- **macOS ARM64**: `@ruv.io/opencv-sdk-darwin-arm64`
- **Windows x64**: `@ruv.io/opencv-sdk-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/opencv-sdk-wasm32` (fallback)
...
// CommonJS
const { OpencvSdk } = require('@ruv.io/opencv-sdk')
```
...
```typescript
import { OpencvSdk, OpencvSdkError } from '@ruv.io/opencv-sdk'
...
```typescript
import { OpencvSdk, Config, LogLevel } from '@ruv.io/opencv-sdk'
...
- **NPM Package**: [@ruv.io/opencv-sdk](https://www.npmjs.com/package/@ruv.io/opencv-sdk)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [opencv-sdk](https://crates.io/crates/opencv-sdk)
- **Documentation**: [docs.ruv.io/opencv-sdk](https://docs.ruv.io/opencv-sdk)
...
![NPM](https://nodei.co/npm/@ruv.io/opencv-sdk.png?downloads=true&downloadRank=true&stars=true)
