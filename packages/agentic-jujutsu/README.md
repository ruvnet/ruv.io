# 🛠️ @ruv.io/agentic-jujutsu

> AI-powered Jujutsu VCS wrapper for multi-agent collaboration - 10-100x faster than Git with MCP protocol support

[![npm version](https://img.shields.io/npm/v/@ruv.io/agentic-jujutsu.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/agentic-jujutsu)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/agentic-jujutsu.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/agentic-jujutsu)
[![license](https://img.shields.io/npm/l/@ruv.io/agentic-jujutsu.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/agentic-jujutsu` is a high-performance Node.js native addon that provides TypeScript bindings for the [`agentic-jujutsu`](https://crates.io/crates/agentic-jujutsu) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/agentic-jujutsu
```

### Using yarn

```bash
yarn add @ruv.io/agentic-jujutsu
```

### Using pnpm

```bash
pnpm add @ruv.io/agentic-jujutsu
```
...
- **Linux x64**: `@ruv.io/agentic-jujutsu-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/agentic-jujutsu-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/agentic-jujutsu-darwin-x64`
- **macOS ARM64**: `@ruv.io/agentic-jujutsu-darwin-arm64`
- **Windows x64**: `@ruv.io/agentic-jujutsu-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/agentic-jujutsu-wasm32` (fallback)
...
```typescript
import { AgenticJujutsu } from '@ruv.io/agentic-jujutsu'
...
```typescript
import { AgenticJujutsu, Config } from '@ruv.io/agentic-jujutsu'
...
// CommonJS
const { AgenticJujutsu } = require('@ruv.io/agentic-jujutsu')
```
...
```typescript
import { AgenticJujutsu, AgenticJujutsuError } from '@ruv.io/agentic-jujutsu'
...
```typescript
import { AgenticJujutsu, Config, LogLevel } from '@ruv.io/agentic-jujutsu'
...
cd ruv.io/packages/agentic-jujutsu
...
- **NPM Package**: [@ruv.io/agentic-jujutsu](https://www.npmjs.com/package/@ruv.io/agentic-jujutsu)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [agentic-jujutsu](https://crates.io/crates/agentic-jujutsu)
- **Documentation**: [docs.ruv.io/agentic-jujutsu](https://docs.ruv.io/agentic-jujutsu)
...
![NPM](https://nodei.co/npm/@ruv.io/agentic-jujutsu.png?downloads=true&downloadRank=true&stars=true)
