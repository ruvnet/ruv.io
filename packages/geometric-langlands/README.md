...
[![npm version](https://img.shields.io/npm/v/@ruv.io/geometric-langlands.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/geometric-langlands)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/geometric-langlands.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/geometric-langlands)
[![license](https://img.shields.io/npm/l/@ruv.io/geometric-langlands.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/geometric-langlands` is a high-performance Node.js native addon that provides TypeScript bindings for the [`geometric-langlands`](https://crates.io/crates/geometric-langlands) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/geometric-langlands
```

### Using yarn

```bash
yarn add @ruv.io/geometric-langlands
```

### Using pnpm

```bash
pnpm add @ruv.io/geometric-langlands
```
...
- **Linux x64**: `@ruv.io/geometric-langlands-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/geometric-langlands-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/geometric-langlands-darwin-x64`
- **macOS ARM64**: `@ruv.io/geometric-langlands-darwin-arm64`
- **Windows x64**: `@ruv.io/geometric-langlands-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/geometric-langlands-wasm32` (fallback)
...
```typescript
import { GeometricLanglands } from '@ruv.io/geometric-langlands'
...
```typescript
import { GeometricLanglands, Config } from '@ruv.io/geometric-langlands'
...
// CommonJS
const { GeometricLanglands } = require('@ruv.io/geometric-langlands')
```
...
```typescript
import { GeometricLanglands, GeometricLanglandsError } from '@ruv.io/geometric-langlands'
...
```typescript
import { GeometricLanglands, Config, LogLevel } from '@ruv.io/geometric-langlands'
...
cd ruv.io/packages/geometric-langlands
...
- **NPM Package**: [@ruv.io/geometric-langlands](https://www.npmjs.com/package/@ruv.io/geometric-langlands)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [geometric-langlands](https://crates.io/crates/geometric-langlands)
- **Documentation**: [docs.ruv.io/geometric-langlands](https://docs.ruv.io/geometric-langlands)
...
![NPM](https://nodei.co/npm/@ruv.io/geometric-langlands.png?downloads=true&downloadRank=true&stars=true)
