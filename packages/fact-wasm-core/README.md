# 🛠️ @ruv.io/fact-wasm-core

> FACT WASM Core - High-performance WebAssembly cognitive processing engine with advanced caching and template optimization

[![npm version](https://img.shields.io/npm/v/@ruv.io/fact-wasm-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/fact-wasm-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/fact-wasm-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/fact-wasm-core)
[![license](https://img.shields.io/npm/l/@ruv.io/fact-wasm-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/fact-wasm-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`fact-wasm-core`](https://crates.io/crates/fact-wasm-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/fact-wasm-core
```

### Using yarn

```bash
yarn add @ruv.io/fact-wasm-core
```

### Using pnpm

```bash
pnpm add @ruv.io/fact-wasm-core
```
...
- **Linux x64**: `@ruv.io/fact-wasm-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/fact-wasm-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/fact-wasm-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/fact-wasm-core-darwin-arm64`
- **Windows x64**: `@ruv.io/fact-wasm-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/fact-wasm-core-wasm32` (fallback)
...
```typescript
import { FactWasmCore } from '@ruv.io/fact-wasm-core'
...
```typescript
import { FactWasmCore, Config } from '@ruv.io/fact-wasm-core'
...
// CommonJS
const { FactWasmCore } = require('@ruv.io/fact-wasm-core')
```
...
```typescript
import { FactWasmCore, FactWasmCoreError } from '@ruv.io/fact-wasm-core'
...
```typescript
import { FactWasmCore, Config, LogLevel } from '@ruv.io/fact-wasm-core'
...
cd ruv.io/packages/fact-wasm-core
...
- **NPM Package**: [@ruv.io/fact-wasm-core](https://www.npmjs.com/package/@ruv.io/fact-wasm-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [fact-wasm-core](https://crates.io/crates/fact-wasm-core)
- **Documentation**: [docs.ruv.io/fact-wasm-core](https://docs.ruv.io/fact-wasm-core)
...
![NPM](https://nodei.co/npm/@ruv.io/fact-wasm-core.png?downloads=true&downloadRank=true&stars=true)
