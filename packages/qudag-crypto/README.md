# ⚛️ @ruv.io/qudag-crypto

> Quantum-resistant cryptography library for QuDAG - includes ML-KEM-768, ML-DSA, HQC, and BLAKE3

[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag-crypto.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-crypto)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag-crypto.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-crypto)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag-crypto.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qudag-crypto` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-crypto`](https://crates.io/crates/qudag-crypto) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qudag-crypto
```

### Using yarn

```bash
yarn add @ruv.io/qudag-crypto
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag-crypto
```
...
- **Linux x64**: `@ruv.io/qudag-crypto-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-crypto-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-crypto-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-crypto-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-crypto-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-crypto-wasm32` (fallback)
...
```typescript
import { QudagCrypto } from '@ruv.io/qudag-crypto'
...
```typescript
import { QudagCrypto, Config } from '@ruv.io/qudag-crypto'
...
// CommonJS
const { QudagCrypto } = require('@ruv.io/qudag-crypto')
```
...
```typescript
import { QudagCrypto, QudagCryptoError } from '@ruv.io/qudag-crypto'
...
```typescript
import { QudagCrypto, Config, LogLevel } from '@ruv.io/qudag-crypto'
...
cd ruv.io/packages/qudag-crypto
...
- **NPM Package**: [@ruv.io/qudag-crypto](https://www.npmjs.com/package/@ruv.io/qudag-crypto)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag-crypto](https://crates.io/crates/qudag-crypto)
- **Documentation**: [docs.ruv.io/qudag-crypto](https://docs.ruv.io/qudag-crypto)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag-crypto.png?downloads=true&downloadRank=true&stars=true)
