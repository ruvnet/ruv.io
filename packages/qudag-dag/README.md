...
[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag-dag.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-dag)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag-dag.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-dag)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag-dag.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qudag-dag` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-dag`](https://crates.io/crates/qudag-dag) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qudag-dag
```

### Using yarn

```bash
yarn add @ruv.io/qudag-dag
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag-dag
```
...
- **Linux x64**: `@ruv.io/qudag-dag-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-dag-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-dag-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-dag-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-dag-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-dag-wasm32` (fallback)
...
```typescript
import { QudagDag } from '@ruv.io/qudag-dag'
...
```typescript
import { QudagDag, Config } from '@ruv.io/qudag-dag'
...
// CommonJS
const { QudagDag } = require('@ruv.io/qudag-dag')
```
...
```typescript
import { QudagDag, QudagDagError } from '@ruv.io/qudag-dag'
...
```typescript
import { QudagDag, Config, LogLevel } from '@ruv.io/qudag-dag'
...
- **NPM Package**: [@ruv.io/qudag-dag](https://www.npmjs.com/package/@ruv.io/qudag-dag)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag-dag](https://crates.io/crates/qudag-dag)
- **Documentation**: [docs.ruv.io/qudag-dag](https://docs.ruv.io/qudag-dag)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag-dag.png?downloads=true&downloadRank=true&stars=true)
