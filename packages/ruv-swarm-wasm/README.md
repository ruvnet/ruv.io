# 🐝 @ruv.io/ruv-swarm-wasm

> WebAssembly bindings for ruv-swarm neural network orchestration

[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-swarm-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-swarm-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-wasm)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-swarm-wasm.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-swarm-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-wasm`](https://crates.io/crates/ruv-swarm-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-swarm-wasm
```

### Using yarn

```bash
yarn add @ruv.io/ruv-swarm-wasm
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-swarm-wasm
```
...
- **Linux x64**: `@ruv.io/ruv-swarm-wasm-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-swarm-wasm-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-swarm-wasm-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-swarm-wasm-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-swarm-wasm-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-swarm-wasm-wasm32` (fallback)
...
```typescript
import { RuvSwarmWasm } from '@ruv.io/ruv-swarm-wasm'
...
```typescript
import { RuvSwarmWasm, Config } from '@ruv.io/ruv-swarm-wasm'
...
// CommonJS
const { RuvSwarmWasm } = require('@ruv.io/ruv-swarm-wasm')
```
...
```typescript
import { RuvSwarmWasm, RuvSwarmWasmError } from '@ruv.io/ruv-swarm-wasm'
...
```typescript
import { RuvSwarmWasm, Config, LogLevel } from '@ruv.io/ruv-swarm-wasm'
...
cd ruv.io/packages/ruv-swarm-wasm
...
- **NPM Package**: [@ruv.io/ruv-swarm-wasm](https://www.npmjs.com/package/@ruv.io/ruv-swarm-wasm)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-swarm-wasm](https://crates.io/crates/ruv-swarm-wasm)
- **Documentation**: [docs.ruv.io/ruv-swarm-wasm](https://docs.ruv.io/ruv-swarm-wasm)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-swarm-wasm.png?downloads=true&downloadRank=true&stars=true)
