...
[![npm version](https://img.shields.io/npm/v/@ruv.io/governance.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/governance)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/governance.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/governance)
[![license](https://img.shields.io/npm/l/@ruv.io/governance.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/governance` is a high-performance Node.js native addon that provides TypeScript bindings for the [`governance`](https://crates.io/crates/governance) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/governance
```

### Using yarn

```bash
yarn add @ruv.io/governance
```

### Using pnpm

```bash
pnpm add @ruv.io/governance
```
...
- **Linux x64**: `@ruv.io/governance-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/governance-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/governance-darwin-x64`
- **macOS ARM64**: `@ruv.io/governance-darwin-arm64`
- **Windows x64**: `@ruv.io/governance-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/governance-wasm32` (fallback)
...
```typescript
import { Governance } from '@ruv.io/governance'
...
```typescript
import { Governance, Config } from '@ruv.io/governance'
...
// CommonJS
const { Governance } = require('@ruv.io/governance')
```
...
```typescript
import { Governance, GovernanceError } from '@ruv.io/governance'
...
```typescript
import { Governance, Config, LogLevel } from '@ruv.io/governance'
...
- **NPM Package**: [@ruv.io/governance](https://www.npmjs.com/package/@ruv.io/governance)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [governance](https://crates.io/crates/governance)
- **Documentation**: [docs.ruv.io/governance](https://docs.ruv.io/governance)
...
![NPM](https://nodei.co/npm/@ruv.io/governance.png?downloads=true&downloadRank=true&stars=true)
