# 🧠 @ruv.io/synaptic-neural-wasm

> WASM-optimized neural network engine for Synaptic Neural Mesh with SIMD acceleration

[![npm version](https://img.shields.io/npm/v/@ruv.io/synaptic-neural-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/synaptic-neural-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/synaptic-neural-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/synaptic-neural-wasm)
[![license](https://img.shields.io/npm/l/@ruv.io/synaptic-neural-wasm.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/synaptic-neural-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`synaptic-neural-wasm`](https://crates.io/crates/synaptic-neural-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/synaptic-neural-wasm
```

### Using yarn

```bash
yarn add @ruv.io/synaptic-neural-wasm
```

### Using pnpm

```bash
pnpm add @ruv.io/synaptic-neural-wasm
```
...
- **Linux x64**: `@ruv.io/synaptic-neural-wasm-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/synaptic-neural-wasm-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/synaptic-neural-wasm-darwin-x64`
- **macOS ARM64**: `@ruv.io/synaptic-neural-wasm-darwin-arm64`
- **Windows x64**: `@ruv.io/synaptic-neural-wasm-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/synaptic-neural-wasm-wasm32` (fallback)
...
```typescript
import { SynapticNeuralWasm } from '@ruv.io/synaptic-neural-wasm'
...
```typescript
import { SynapticNeuralWasm, Config } from '@ruv.io/synaptic-neural-wasm'
...
// CommonJS
const { SynapticNeuralWasm } = require('@ruv.io/synaptic-neural-wasm')
```
...
```typescript
import { SynapticNeuralWasm, SynapticNeuralWasmError } from '@ruv.io/synaptic-neural-wasm'
...
```typescript
import { SynapticNeuralWasm, Config, LogLevel } from '@ruv.io/synaptic-neural-wasm'
...
cd ruv.io/packages/synaptic-neural-wasm
...
- **NPM Package**: [@ruv.io/synaptic-neural-wasm](https://www.npmjs.com/package/@ruv.io/synaptic-neural-wasm)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [synaptic-neural-wasm](https://crates.io/crates/synaptic-neural-wasm)
- **Documentation**: [docs.ruv.io/synaptic-neural-wasm](https://docs.ruv.io/synaptic-neural-wasm)
...
![NPM](https://nodei.co/npm/@ruv.io/synaptic-neural-wasm.png?downloads=true&downloadRank=true&stars=true)
