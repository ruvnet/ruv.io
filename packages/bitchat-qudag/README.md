# ⚛️ @ruv.io/bitchat-qudag

> BitChat messaging integration for QuDAG with WASM support

[![npm version](https://img.shields.io/npm/v/@ruv.io/bitchat-qudag.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/bitchat-qudag)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/bitchat-qudag.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/bitchat-qudag)
[![license](https://img.shields.io/npm/l/@ruv.io/bitchat-qudag.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/bitchat-qudag` is a high-performance Node.js native addon that provides TypeScript bindings for the [`bitchat-qudag`](https://crates.io/crates/bitchat-qudag) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/bitchat-qudag
```

### Using yarn

```bash
yarn add @ruv.io/bitchat-qudag
```

### Using pnpm

```bash
pnpm add @ruv.io/bitchat-qudag
```
...
- **Linux x64**: `@ruv.io/bitchat-qudag-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/bitchat-qudag-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/bitchat-qudag-darwin-x64`
- **macOS ARM64**: `@ruv.io/bitchat-qudag-darwin-arm64`
- **Windows x64**: `@ruv.io/bitchat-qudag-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/bitchat-qudag-wasm32` (fallback)
...
```typescript
import { BitchatQudag } from '@ruv.io/bitchat-qudag'
...
```typescript
import { BitchatQudag, Config } from '@ruv.io/bitchat-qudag'
...
// CommonJS
const { BitchatQudag } = require('@ruv.io/bitchat-qudag')
```
...
```typescript
import { BitchatQudag, BitchatQudagError } from '@ruv.io/bitchat-qudag'
...
```typescript
import { BitchatQudag, Config, LogLevel } from '@ruv.io/bitchat-qudag'
...
cd ruv.io/packages/bitchat-qudag
...
- **NPM Package**: [@ruv.io/bitchat-qudag](https://www.npmjs.com/package/@ruv.io/bitchat-qudag)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [bitchat-qudag](https://crates.io/crates/bitchat-qudag)
- **Documentation**: [docs.ruv.io/bitchat-qudag](https://docs.ruv.io/bitchat-qudag)
...
![NPM](https://nodei.co/npm/@ruv.io/bitchat-qudag.png?downloads=true&downloadRank=true&stars=true)
