...
[![npm version](https://img.shields.io/npm/v/@ruv.io/code-mesh-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/code-mesh-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/code-mesh-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/code-mesh-core)
[![license](https://img.shields.io/npm/l/@ruv.io/code-mesh-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/code-mesh-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`code-mesh-core`](https://crates.io/crates/code-mesh-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/code-mesh-core
```

### Using yarn

```bash
yarn add @ruv.io/code-mesh-core
```

### Using pnpm

```bash
pnpm add @ruv.io/code-mesh-core
```
...
- **Linux x64**: `@ruv.io/code-mesh-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/code-mesh-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/code-mesh-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/code-mesh-core-darwin-arm64`
- **Windows x64**: `@ruv.io/code-mesh-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/code-mesh-core-wasm32` (fallback)
...
```typescript
import { CodeMeshCore } from '@ruv.io/code-mesh-core'
...
```typescript
import { CodeMeshCore, Config } from '@ruv.io/code-mesh-core'
...
// CommonJS
const { CodeMeshCore } = require('@ruv.io/code-mesh-core')
```
...
```typescript
import { CodeMeshCore, CodeMeshCoreError } from '@ruv.io/code-mesh-core'
...
```typescript
import { CodeMeshCore, Config, LogLevel } from '@ruv.io/code-mesh-core'
...
cd ruv.io/packages/code-mesh-core
...
- **NPM Package**: [@ruv.io/code-mesh-core](https://www.npmjs.com/package/@ruv.io/code-mesh-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [code-mesh-core](https://crates.io/crates/code-mesh-core)
- **Documentation**: [docs.ruv.io/code-mesh-core](https://docs.ruv.io/code-mesh-core)
...
![NPM](https://nodei.co/npm/@ruv.io/code-mesh-core.png?downloads=true&downloadRank=true&stars=true)
