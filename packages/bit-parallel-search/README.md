# 🛠️ @ruv.io/bit-parallel-search

> Blazing fast string search using bit-parallel algorithms - up to 8x faster than naive search

[![npm version](https://img.shields.io/npm/v/@ruv.io/bit-parallel-search.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/bit-parallel-search)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/bit-parallel-search.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/bit-parallel-search)
[![license](https://img.shields.io/npm/l/@ruv.io/bit-parallel-search.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/bit-parallel-search` is a high-performance Node.js native addon that provides TypeScript bindings for the [`bit-parallel-search`](https://crates.io/crates/bit-parallel-search) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/bit-parallel-search
```

### Using yarn

```bash
yarn add @ruv.io/bit-parallel-search
```

### Using pnpm

```bash
pnpm add @ruv.io/bit-parallel-search
```
...
- **Linux x64**: `@ruv.io/bit-parallel-search-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/bit-parallel-search-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/bit-parallel-search-darwin-x64`
- **macOS ARM64**: `@ruv.io/bit-parallel-search-darwin-arm64`
- **Windows x64**: `@ruv.io/bit-parallel-search-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/bit-parallel-search-wasm32` (fallback)
...
```typescript
import { BitParallelSearch } from '@ruv.io/bit-parallel-search'
...
```typescript
import { BitParallelSearch, Config } from '@ruv.io/bit-parallel-search'
...
// CommonJS
const { BitParallelSearch } = require('@ruv.io/bit-parallel-search')
```
...
```typescript
import { BitParallelSearch, BitParallelSearchError } from '@ruv.io/bit-parallel-search'
...
```typescript
import { BitParallelSearch, Config, LogLevel } from '@ruv.io/bit-parallel-search'
...
cd ruv.io/packages/bit-parallel-search
...
- **NPM Package**: [@ruv.io/bit-parallel-search](https://www.npmjs.com/package/@ruv.io/bit-parallel-search)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [bit-parallel-search](https://crates.io/crates/bit-parallel-search)
- **Documentation**: [docs.ruv.io/bit-parallel-search](https://docs.ruv.io/bit-parallel-search)
...
![NPM](https://nodei.co/npm/@ruv.io/bit-parallel-search.png?downloads=true&downloadRank=true&stars=true)
