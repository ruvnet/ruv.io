# 🐝 @ruv.io/ruv-swarm-cli

> Distributed swarm orchestration CLI with cognitive diversity

[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-swarm-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-cli)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-swarm-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-cli)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-swarm-cli.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-swarm-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-cli`](https://crates.io/crates/ruv-swarm-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-swarm-cli
```

### Using yarn

```bash
yarn add @ruv.io/ruv-swarm-cli
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-swarm-cli
```
...
- **Linux x64**: `@ruv.io/ruv-swarm-cli-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-swarm-cli-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-swarm-cli-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-swarm-cli-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-swarm-cli-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-swarm-cli-wasm32` (fallback)
...
```typescript
import { RuvSwarmCli } from '@ruv.io/ruv-swarm-cli'
...
```typescript
import { RuvSwarmCli, Config } from '@ruv.io/ruv-swarm-cli'
...
// CommonJS
const { RuvSwarmCli } = require('@ruv.io/ruv-swarm-cli')
```
...
```typescript
import { RuvSwarmCli, RuvSwarmCliError } from '@ruv.io/ruv-swarm-cli'
...
```typescript
import { RuvSwarmCli, Config, LogLevel } from '@ruv.io/ruv-swarm-cli'
...
cd ruv.io/packages/ruv-swarm-cli
...
- **NPM Package**: [@ruv.io/ruv-swarm-cli](https://www.npmjs.com/package/@ruv.io/ruv-swarm-cli)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-swarm-cli](https://crates.io/crates/ruv-swarm-cli)
- **Documentation**: [docs.ruv.io/ruv-swarm-cli](https://docs.ruv.io/ruv-swarm-cli)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-swarm-cli.png?downloads=true&downloadRank=true&stars=true)
