# 🐝 @ruv.io/code-mesh-cli

> Command-line interface for the Code-Mesh distributed swarm intelligence system

[![npm version](https://img.shields.io/npm/v/@ruv.io/code-mesh-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/code-mesh-cli)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/code-mesh-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/code-mesh-cli)
[![license](https://img.shields.io/npm/l/@ruv.io/code-mesh-cli.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/code-mesh-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`code-mesh-cli`](https://crates.io/crates/code-mesh-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/code-mesh-cli
```

### Using yarn

```bash
yarn add @ruv.io/code-mesh-cli
```

### Using pnpm

```bash
pnpm add @ruv.io/code-mesh-cli
```
...
- **Linux x64**: `@ruv.io/code-mesh-cli-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/code-mesh-cli-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/code-mesh-cli-darwin-x64`
- **macOS ARM64**: `@ruv.io/code-mesh-cli-darwin-arm64`
- **Windows x64**: `@ruv.io/code-mesh-cli-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/code-mesh-cli-wasm32` (fallback)
...
```typescript
import { CodeMeshCli } from '@ruv.io/code-mesh-cli'
...
```typescript
import { CodeMeshCli, Config } from '@ruv.io/code-mesh-cli'
...
// CommonJS
const { CodeMeshCli } = require('@ruv.io/code-mesh-cli')
```
...
```typescript
import { CodeMeshCli, CodeMeshCliError } from '@ruv.io/code-mesh-cli'
...
```typescript
import { CodeMeshCli, Config, LogLevel } from '@ruv.io/code-mesh-cli'
...
cd ruv.io/packages/code-mesh-cli
...
- **NPM Package**: [@ruv.io/code-mesh-cli](https://www.npmjs.com/package/@ruv.io/code-mesh-cli)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [code-mesh-cli](https://crates.io/crates/code-mesh-cli)
- **Documentation**: [docs.ruv.io/code-mesh-cli](https://docs.ruv.io/code-mesh-cli)
...
![NPM](https://nodei.co/npm/@ruv.io/code-mesh-cli.png?downloads=true&downloadRank=true&stars=true)
