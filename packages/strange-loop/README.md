# ⚛️ @ruv.io/strange-loop

> Hyper-optimized strange loops with temporal consciousness and quantum-classical hybrid computing. NPX: npx strange-loops

[![npm version](https://img.shields.io/npm/v/@ruv.io/strange-loop.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/strange-loop)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/strange-loop.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/strange-loop)
[![license](https://img.shields.io/npm/l/@ruv.io/strange-loop.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/strange-loop` is a high-performance Node.js native addon that provides TypeScript bindings for the [`strange-loop`](https://crates.io/crates/strange-loop) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/strange-loop
```

### Using yarn

```bash
yarn add @ruv.io/strange-loop
```

### Using pnpm

```bash
pnpm add @ruv.io/strange-loop
```
...
- **Linux x64**: `@ruv.io/strange-loop-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/strange-loop-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/strange-loop-darwin-x64`
- **macOS ARM64**: `@ruv.io/strange-loop-darwin-arm64`
- **Windows x64**: `@ruv.io/strange-loop-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/strange-loop-wasm32` (fallback)
...
```typescript
import { StrangeLoop } from '@ruv.io/strange-loop'
...
```typescript
import { StrangeLoop, Config } from '@ruv.io/strange-loop'
...
// CommonJS
const { StrangeLoop } = require('@ruv.io/strange-loop')
```
...
```typescript
import { StrangeLoop, StrangeLoopError } from '@ruv.io/strange-loop'
...
```typescript
import { StrangeLoop, Config, LogLevel } from '@ruv.io/strange-loop'
...
cd ruv.io/packages/strange-loop
...
- **NPM Package**: [@ruv.io/strange-loop](https://www.npmjs.com/package/@ruv.io/strange-loop)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [strange-loop](https://crates.io/crates/strange-loop)
- **Documentation**: [docs.ruv.io/strange-loop](https://docs.ruv.io/strange-loop)
...
![NPM](https://nodei.co/npm/@ruv.io/strange-loop.png?downloads=true&downloadRank=true&stars=true)
