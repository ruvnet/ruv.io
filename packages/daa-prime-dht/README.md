# 🗄️ @ruv.io/daa-prime-dht

> Kademlia-based distributed hash table implementation for Prime distributed ML framework

[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-prime-dht.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-prime-dht)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-prime-dht.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-prime-dht)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-prime-dht.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-prime-dht` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-prime-dht`](https://crates.io/crates/daa-prime-dht) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-prime-dht
```

### Using yarn

```bash
yarn add @ruv.io/daa-prime-dht
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-prime-dht
```
...
- **Linux x64**: `@ruv.io/daa-prime-dht-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-prime-dht-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-prime-dht-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-prime-dht-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-prime-dht-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-prime-dht-wasm32` (fallback)
...
```typescript
import { DaaPrimeDht } from '@ruv.io/daa-prime-dht'
...
```typescript
import { DaaPrimeDht, Config } from '@ruv.io/daa-prime-dht'
...
// CommonJS
const { DaaPrimeDht } = require('@ruv.io/daa-prime-dht')
```
...
```typescript
import { DaaPrimeDht, DaaPrimeDhtError } from '@ruv.io/daa-prime-dht'
...
```typescript
import { DaaPrimeDht, Config, LogLevel } from '@ruv.io/daa-prime-dht'
...
cd ruv.io/packages/daa-prime-dht
...
- **NPM Package**: [@ruv.io/daa-prime-dht](https://www.npmjs.com/package/@ruv.io/daa-prime-dht)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-prime-dht](https://crates.io/crates/daa-prime-dht)
- **Documentation**: [docs.ruv.io/daa-prime-dht](https://docs.ruv.io/daa-prime-dht)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-prime-dht.png?downloads=true&downloadRank=true&stars=true)
