...
[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-cli)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-cli)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-cli.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-cli`](https://crates.io/crates/daa-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-cli
```

### Using yarn

```bash
yarn add @ruv.io/daa-cli
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-cli
```
...
- **Linux x64**: `@ruv.io/daa-cli-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-cli-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-cli-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-cli-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-cli-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-cli-wasm32` (fallback)
...
```typescript
import { DaaCli } from '@ruv.io/daa-cli'
...
```typescript
import { DaaCli, Config } from '@ruv.io/daa-cli'
...
// CommonJS
const { DaaCli } = require('@ruv.io/daa-cli')
```
...
```typescript
import { DaaCli, DaaCliError } from '@ruv.io/daa-cli'
...
```typescript
import { DaaCli, Config, LogLevel } from '@ruv.io/daa-cli'
...
- **NPM Package**: [@ruv.io/daa-cli](https://www.npmjs.com/package/@ruv.io/daa-cli)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-cli](https://crates.io/crates/daa-cli)
- **Documentation**: [docs.ruv.io/daa-cli](https://docs.ruv.io/daa-cli)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-cli.png?downloads=true&downloadRank=true&stars=true)
