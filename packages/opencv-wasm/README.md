# 👁️ @ruv.io/opencv-wasm

> OpenCV WebAssembly bindings for browser deployment

[![npm version](https://img.shields.io/npm/v/@ruv.io/opencv-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/opencv-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/opencv-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/opencv-wasm)
[![license](https://img.shields.io/npm/l/@ruv.io/opencv-wasm.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/opencv-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`opencv-wasm`](https://crates.io/crates/opencv-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/opencv-wasm
```

### Using yarn

```bash
yarn add @ruv.io/opencv-wasm
```

### Using pnpm

```bash
pnpm add @ruv.io/opencv-wasm
```
...
- **Linux x64**: `@ruv.io/opencv-wasm-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/opencv-wasm-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/opencv-wasm-darwin-x64`
- **macOS ARM64**: `@ruv.io/opencv-wasm-darwin-arm64`
- **Windows x64**: `@ruv.io/opencv-wasm-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/opencv-wasm-wasm32` (fallback)
...
```typescript
import { OpencvWasm } from '@ruv.io/opencv-wasm'
...
```typescript
import { OpencvWasm, Config } from '@ruv.io/opencv-wasm'
...
// CommonJS
const { OpencvWasm } = require('@ruv.io/opencv-wasm')
```
...
```typescript
import { OpencvWasm, OpencvWasmError } from '@ruv.io/opencv-wasm'
...
```typescript
import { OpencvWasm, Config, LogLevel } from '@ruv.io/opencv-wasm'
...
cd ruv.io/packages/opencv-wasm
...
- **NPM Package**: [@ruv.io/opencv-wasm](https://www.npmjs.com/package/@ruv.io/opencv-wasm)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [opencv-wasm](https://crates.io/crates/opencv-wasm)
- **Documentation**: [docs.ruv.io/opencv-wasm](https://docs.ruv.io/opencv-wasm)
...
![NPM](https://nodei.co/npm/@ruv.io/opencv-wasm.png?downloads=true&downloadRank=true&stars=true)
