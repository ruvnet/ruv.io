# ⏰ @ruv.io/temporal-lead-solver

> Temporal computational lead via sublinear local solvers for diagonally dominant systems

[![npm version](https://img.shields.io/npm/v/@ruv.io/temporal-lead-solver.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/temporal-lead-solver)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/temporal-lead-solver.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/temporal-lead-solver)
[![license](https://img.shields.io/npm/l/@ruv.io/temporal-lead-solver.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/temporal-lead-solver` is a high-performance Node.js native addon that provides TypeScript bindings for the [`temporal-lead-solver`](https://crates.io/crates/temporal-lead-solver) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/temporal-lead-solver
```

### Using yarn

```bash
yarn add @ruv.io/temporal-lead-solver
```

### Using pnpm

```bash
pnpm add @ruv.io/temporal-lead-solver
```
...
- **Linux x64**: `@ruv.io/temporal-lead-solver-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/temporal-lead-solver-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/temporal-lead-solver-darwin-x64`
- **macOS ARM64**: `@ruv.io/temporal-lead-solver-darwin-arm64`
- **Windows x64**: `@ruv.io/temporal-lead-solver-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/temporal-lead-solver-wasm32` (fallback)
...
```typescript
import { TemporalLeadSolver } from '@ruv.io/temporal-lead-solver'
...
```typescript
import { TemporalLeadSolver, Config } from '@ruv.io/temporal-lead-solver'
...
// CommonJS
const { TemporalLeadSolver } = require('@ruv.io/temporal-lead-solver')
```
...
```typescript
import { TemporalLeadSolver, TemporalLeadSolverError } from '@ruv.io/temporal-lead-solver'
...
```typescript
import { TemporalLeadSolver, Config, LogLevel } from '@ruv.io/temporal-lead-solver'
...
cd ruv.io/packages/temporal-lead-solver
...
- **NPM Package**: [@ruv.io/temporal-lead-solver](https://www.npmjs.com/package/@ruv.io/temporal-lead-solver)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [temporal-lead-solver](https://crates.io/crates/temporal-lead-solver)
- **Documentation**: [docs.ruv.io/temporal-lead-solver](https://docs.ruv.io/temporal-lead-solver)
...
![NPM](https://nodei.co/npm/@ruv.io/temporal-lead-solver.png?downloads=true&downloadRank=true&stars=true)
