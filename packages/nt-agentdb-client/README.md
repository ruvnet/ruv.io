# 🗄️ @ruv.io/nt-agentdb-client

> AgentDB client for Neural Trader - vector database integration and agent memory management

[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-agentdb-client.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-agentdb-client)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-agentdb-client.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-agentdb-client)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-agentdb-client.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-agentdb-client` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-agentdb-client`](https://crates.io/crates/nt-agentdb-client) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-agentdb-client
```

### Using yarn

```bash
yarn add @ruv.io/nt-agentdb-client
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-agentdb-client
```
...
- **Linux x64**: `@ruv.io/nt-agentdb-client-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-agentdb-client-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-agentdb-client-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-agentdb-client-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-agentdb-client-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-agentdb-client-wasm32` (fallback)
...
```typescript
import { NtAgentdbClient } from '@ruv.io/nt-agentdb-client'
...
```typescript
import { NtAgentdbClient, Config } from '@ruv.io/nt-agentdb-client'
...
// CommonJS
const { NtAgentdbClient } = require('@ruv.io/nt-agentdb-client')
```
...
```typescript
import { NtAgentdbClient, NtAgentdbClientError } from '@ruv.io/nt-agentdb-client'
...
```typescript
import { NtAgentdbClient, Config, LogLevel } from '@ruv.io/nt-agentdb-client'
...
cd ruv.io/packages/nt-agentdb-client
...
- **NPM Package**: [@ruv.io/nt-agentdb-client](https://www.npmjs.com/package/@ruv.io/nt-agentdb-client)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-agentdb-client](https://crates.io/crates/nt-agentdb-client)
- **Documentation**: [docs.ruv.io/nt-agentdb-client](https://docs.ruv.io/nt-agentdb-client)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-agentdb-client.png?downloads=true&downloadRank=true&stars=true)
