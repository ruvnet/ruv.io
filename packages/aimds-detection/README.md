# 📦 @ruv.io/aimds-detection

> Fast-path detection layer for AIMDS with pattern matching and anomaly detection

[![npm version](https://img.shields.io/npm/v/@ruv.io/aimds-detection.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/aimds-detection)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/aimds-detection.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/aimds-detection)
[![license](https://img.shields.io/npm/l/@ruv.io/aimds-detection.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/aimds-detection` is a high-performance Node.js native addon that provides TypeScript bindings for the [`aimds-detection`](https://crates.io/crates/aimds-detection) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/aimds-detection
```

### Using yarn

```bash
yarn add @ruv.io/aimds-detection
```

### Using pnpm

```bash
pnpm add @ruv.io/aimds-detection
```
...
- **Linux x64**: `@ruv.io/aimds-detection-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/aimds-detection-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/aimds-detection-darwin-x64`
- **macOS ARM64**: `@ruv.io/aimds-detection-darwin-arm64`
- **Windows x64**: `@ruv.io/aimds-detection-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/aimds-detection-wasm32` (fallback)
...
```typescript
import { AimdsDetection } from '@ruv.io/aimds-detection'
...
```typescript
import { AimdsDetection, Config } from '@ruv.io/aimds-detection'
...
// CommonJS
const { AimdsDetection } = require('@ruv.io/aimds-detection')
```
...
```typescript
import { AimdsDetection, AimdsDetectionError } from '@ruv.io/aimds-detection'
...
```typescript
import { AimdsDetection, Config, LogLevel } from '@ruv.io/aimds-detection'
...
cd ruv.io/packages/aimds-detection
...
- **NPM Package**: [@ruv.io/aimds-detection](https://www.npmjs.com/package/@ruv.io/aimds-detection)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [aimds-detection](https://crates.io/crates/aimds-detection)
- **Documentation**: [docs.ruv.io/aimds-detection](https://docs.ruv.io/aimds-detection)
...
![NPM](https://nodei.co/npm/@ruv.io/aimds-detection.png?downloads=true&downloadRank=true&stars=true)
