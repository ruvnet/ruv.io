...
[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag-mcp.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-mcp)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag-mcp.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-mcp)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag-mcp.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qudag-mcp` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-mcp`](https://crates.io/crates/qudag-mcp) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qudag-mcp
```

### Using yarn

```bash
yarn add @ruv.io/qudag-mcp
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag-mcp
```
...
- **Linux x64**: `@ruv.io/qudag-mcp-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-mcp-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-mcp-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-mcp-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-mcp-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-mcp-wasm32` (fallback)
...
```typescript
import { QudagMcp } from '@ruv.io/qudag-mcp'
...
```typescript
import { QudagMcp, Config } from '@ruv.io/qudag-mcp'
...
// CommonJS
const { QudagMcp } = require('@ruv.io/qudag-mcp')
```
...
```typescript
import { QudagMcp, QudagMcpError } from '@ruv.io/qudag-mcp'
...
```typescript
import { QudagMcp, Config, LogLevel } from '@ruv.io/qudag-mcp'
...
- **NPM Package**: [@ruv.io/qudag-mcp](https://www.npmjs.com/package/@ruv.io/qudag-mcp)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag-mcp](https://crates.io/crates/qudag-mcp)
- **Documentation**: [docs.ruv.io/qudag-mcp](https://docs.ruv.io/qudag-mcp)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag-mcp.png?downloads=true&downloadRank=true&stars=true)
