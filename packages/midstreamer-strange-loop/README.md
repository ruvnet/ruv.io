# ⏰ @ruv.io/midstreamer-strange-loop

> Self-referential systems and meta-learning

[![npm version](https://img.shields.io/npm/v/@ruv.io/midstreamer-strange-loop.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-strange-loop)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/midstreamer-strange-loop.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-strange-loop)
[![license](https://img.shields.io/npm/l/@ruv.io/midstreamer-strange-loop.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/midstreamer-strange-loop` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-strange-loop`](https://crates.io/crates/midstreamer-strange-loop) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/midstreamer-strange-loop
```

### Using yarn

```bash
yarn add @ruv.io/midstreamer-strange-loop
```

### Using pnpm

```bash
pnpm add @ruv.io/midstreamer-strange-loop
```
...
- **Linux x64**: `@ruv.io/midstreamer-strange-loop-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/midstreamer-strange-loop-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/midstreamer-strange-loop-darwin-x64`
- **macOS ARM64**: `@ruv.io/midstreamer-strange-loop-darwin-arm64`
- **Windows x64**: `@ruv.io/midstreamer-strange-loop-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/midstreamer-strange-loop-wasm32` (fallback)
...
```typescript
import { MidstreamerStrangeLoop } from '@ruv.io/midstreamer-strange-loop'
...
```typescript
import { MidstreamerStrangeLoop, Config } from '@ruv.io/midstreamer-strange-loop'
...
// CommonJS
const { MidstreamerStrangeLoop } = require('@ruv.io/midstreamer-strange-loop')
```
...
```typescript
import { MidstreamerStrangeLoop, MidstreamerStrangeLoopError } from '@ruv.io/midstreamer-strange-loop'
...
```typescript
import { MidstreamerStrangeLoop, Config, LogLevel } from '@ruv.io/midstreamer-strange-loop'
...
cd ruv.io/packages/midstreamer-strange-loop
...
- **NPM Package**: [@ruv.io/midstreamer-strange-loop](https://www.npmjs.com/package/@ruv.io/midstreamer-strange-loop)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [midstreamer-strange-loop](https://crates.io/crates/midstreamer-strange-loop)
- **Documentation**: [docs.ruv.io/midstreamer-strange-loop](https://docs.ruv.io/midstreamer-strange-loop)
...
![NPM](https://nodei.co/npm/@ruv.io/midstreamer-strange-loop.png?downloads=true&downloadRank=true&stars=true)
