# 📦 @ruv.io/agentic-payments

> Autonomous multi-agent Ed25519 signature verification with Byzantine fault tolerance

[![npm version](https://img.shields.io/npm/v/@ruv.io/agentic-payments.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/agentic-payments)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/agentic-payments.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/agentic-payments)
[![license](https://img.shields.io/npm/l/@ruv.io/agentic-payments.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/agentic-payments` is a high-performance Node.js native addon that provides TypeScript bindings for the [`agentic-payments`](https://crates.io/crates/agentic-payments) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/agentic-payments
```

### Using yarn

```bash
yarn add @ruv.io/agentic-payments
```

### Using pnpm

```bash
pnpm add @ruv.io/agentic-payments
```
...
- **Linux x64**: `@ruv.io/agentic-payments-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/agentic-payments-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/agentic-payments-darwin-x64`
- **macOS ARM64**: `@ruv.io/agentic-payments-darwin-arm64`
- **Windows x64**: `@ruv.io/agentic-payments-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/agentic-payments-wasm32` (fallback)
...
```typescript
import { AgenticPayments } from '@ruv.io/agentic-payments'
...
```typescript
import { AgenticPayments, Config } from '@ruv.io/agentic-payments'
...
// CommonJS
const { AgenticPayments } = require('@ruv.io/agentic-payments')
```
...
```typescript
import { AgenticPayments, AgenticPaymentsError } from '@ruv.io/agentic-payments'
...
```typescript
import { AgenticPayments, Config, LogLevel } from '@ruv.io/agentic-payments'
...
cd ruv.io/packages/agentic-payments
...
- **NPM Package**: [@ruv.io/agentic-payments](https://www.npmjs.com/package/@ruv.io/agentic-payments)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [agentic-payments](https://crates.io/crates/agentic-payments)
- **Documentation**: [docs.ruv.io/agentic-payments](https://docs.ruv.io/agentic-payments)
...
![NPM](https://nodei.co/npm/@ruv.io/agentic-payments.png?downloads=true&downloadRank=true&stars=true)
