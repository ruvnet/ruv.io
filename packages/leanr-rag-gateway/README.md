# 📝 @ruv.io/leanr-rag-gateway

> Multi-lane RAG gateway with cost routing and verified safety proofs using lean-agentic

[![npm version](https://img.shields.io/npm/v/@ruv.io/leanr-rag-gateway.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/leanr-rag-gateway)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/leanr-rag-gateway.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/leanr-rag-gateway)
[![license](https://img.shields.io/npm/l/@ruv.io/leanr-rag-gateway.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/leanr-rag-gateway` is a high-performance Node.js native addon that provides TypeScript bindings for the [`leanr-rag-gateway`](https://crates.io/crates/leanr-rag-gateway) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/leanr-rag-gateway
```

### Using yarn

```bash
yarn add @ruv.io/leanr-rag-gateway
```

### Using pnpm

```bash
pnpm add @ruv.io/leanr-rag-gateway
```
...
- **Linux x64**: `@ruv.io/leanr-rag-gateway-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/leanr-rag-gateway-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/leanr-rag-gateway-darwin-x64`
- **macOS ARM64**: `@ruv.io/leanr-rag-gateway-darwin-arm64`
- **Windows x64**: `@ruv.io/leanr-rag-gateway-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/leanr-rag-gateway-wasm32` (fallback)
...
```typescript
import { LeanrRagGateway } from '@ruv.io/leanr-rag-gateway'
...
```typescript
import { LeanrRagGateway, Config } from '@ruv.io/leanr-rag-gateway'
...
// CommonJS
const { LeanrRagGateway } = require('@ruv.io/leanr-rag-gateway')
```
...
```typescript
import { LeanrRagGateway, LeanrRagGatewayError } from '@ruv.io/leanr-rag-gateway'
...
```typescript
import { LeanrRagGateway, Config, LogLevel } from '@ruv.io/leanr-rag-gateway'
...
cd ruv.io/packages/leanr-rag-gateway
...
- **NPM Package**: [@ruv.io/leanr-rag-gateway](https://www.npmjs.com/package/@ruv.io/leanr-rag-gateway)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [leanr-rag-gateway](https://crates.io/crates/leanr-rag-gateway)
- **Documentation**: [docs.ruv.io/leanr-rag-gateway](https://docs.ruv.io/leanr-rag-gateway)
...
![NPM](https://nodei.co/npm/@ruv.io/leanr-rag-gateway.png?downloads=true&downloadRank=true&stars=true)
