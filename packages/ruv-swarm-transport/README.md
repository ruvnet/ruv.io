# 🐝 @ruv.io/ruv-swarm-transport

> Transport layer for RUV-FANN swarm communication with WebSocket and SharedMemory support

[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-swarm-transport.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-transport)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-swarm-transport.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-transport)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-swarm-transport.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-swarm-transport` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-transport`](https://crates.io/crates/ruv-swarm-transport) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-swarm-transport
```

### Using yarn

```bash
yarn add @ruv.io/ruv-swarm-transport
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-swarm-transport
```
...
- **Linux x64**: `@ruv.io/ruv-swarm-transport-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-swarm-transport-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-swarm-transport-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-swarm-transport-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-swarm-transport-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-swarm-transport-wasm32` (fallback)
...
```typescript
import { RuvSwarmTransport } from '@ruv.io/ruv-swarm-transport'
...
```typescript
import { RuvSwarmTransport, Config } from '@ruv.io/ruv-swarm-transport'
...
// CommonJS
const { RuvSwarmTransport } = require('@ruv.io/ruv-swarm-transport')
```
...
```typescript
import { RuvSwarmTransport, RuvSwarmTransportError } from '@ruv.io/ruv-swarm-transport'
...
```typescript
import { RuvSwarmTransport, Config, LogLevel } from '@ruv.io/ruv-swarm-transport'
...
cd ruv.io/packages/ruv-swarm-transport
...
- **NPM Package**: [@ruv.io/ruv-swarm-transport](https://www.npmjs.com/package/@ruv.io/ruv-swarm-transport)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-swarm-transport](https://crates.io/crates/ruv-swarm-transport)
- **Documentation**: [docs.ruv.io/ruv-swarm-transport](https://docs.ruv.io/ruv-swarm-transport)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-swarm-transport.png?downloads=true&downloadRank=true&stars=true)
