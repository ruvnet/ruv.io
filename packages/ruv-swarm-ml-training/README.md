# 🐝 @ruv.io/ruv-swarm-ml-training

> Advanced ML training pipeline for neuro-divergent models in RUV Swarm

[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-swarm-ml-training.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-ml-training)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-swarm-ml-training.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-ml-training)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-swarm-ml-training.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-swarm-ml-training` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-ml-training`](https://crates.io/crates/ruv-swarm-ml-training) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-swarm-ml-training
```

### Using yarn

```bash
yarn add @ruv.io/ruv-swarm-ml-training
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-swarm-ml-training
```
...
- **Linux x64**: `@ruv.io/ruv-swarm-ml-training-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-swarm-ml-training-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-swarm-ml-training-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-swarm-ml-training-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-swarm-ml-training-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-swarm-ml-training-wasm32` (fallback)
...
```typescript
import { RuvSwarmMlTraining } from '@ruv.io/ruv-swarm-ml-training'
...
```typescript
import { RuvSwarmMlTraining, Config } from '@ruv.io/ruv-swarm-ml-training'
...
// CommonJS
const { RuvSwarmMlTraining } = require('@ruv.io/ruv-swarm-ml-training')
```
...
```typescript
import { RuvSwarmMlTraining, RuvSwarmMlTrainingError } from '@ruv.io/ruv-swarm-ml-training'
...
```typescript
import { RuvSwarmMlTraining, Config, LogLevel } from '@ruv.io/ruv-swarm-ml-training'
...
cd ruv.io/packages/ruv-swarm-ml-training
...
- **NPM Package**: [@ruv.io/ruv-swarm-ml-training](https://www.npmjs.com/package/@ruv.io/ruv-swarm-ml-training)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-swarm-ml-training](https://crates.io/crates/ruv-swarm-ml-training)
- **Documentation**: [docs.ruv.io/ruv-swarm-ml-training](https://docs.ruv.io/ruv-swarm-ml-training)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-swarm-ml-training.png?downloads=true&downloadRank=true&stars=true)
