# 🧠 @ruv.io/micro_cartan_attn

> Complete Cartan matrix attention mechanisms with proper Lie algebra structures

[![npm version](https://img.shields.io/npm/v/@ruv.io/micro_cartan_attn.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_cartan_attn)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/micro_cartan_attn.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_cartan_attn)
[![license](https://img.shields.io/npm/l/@ruv.io/micro_cartan_attn.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/micro_cartan_attn` is a high-performance Node.js native addon that provides TypeScript bindings for the [`micro_cartan_attn`](https://crates.io/crates/micro_cartan_attn) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/micro_cartan_attn
```

### Using yarn

```bash
yarn add @ruv.io/micro_cartan_attn
```

### Using pnpm

```bash
pnpm add @ruv.io/micro_cartan_attn
```
...
- **Linux x64**: `@ruv.io/micro_cartan_attn-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/micro_cartan_attn-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/micro_cartan_attn-darwin-x64`
- **macOS ARM64**: `@ruv.io/micro_cartan_attn-darwin-arm64`
- **Windows x64**: `@ruv.io/micro_cartan_attn-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/micro_cartan_attn-wasm32` (fallback)
...
```typescript
import { Micro_cartan_attn } from '@ruv.io/micro_cartan_attn'
...
```typescript
import { Micro_cartan_attn, Config } from '@ruv.io/micro_cartan_attn'
...
// CommonJS
const { Micro_cartan_attn } = require('@ruv.io/micro_cartan_attn')
```
...
```typescript
import { Micro_cartan_attn, Micro_cartan_attnError } from '@ruv.io/micro_cartan_attn'
...
```typescript
import { Micro_cartan_attn, Config, LogLevel } from '@ruv.io/micro_cartan_attn'
...
cd ruv.io/packages/micro_cartan_attn
...
- **NPM Package**: [@ruv.io/micro_cartan_attn](https://www.npmjs.com/package/@ruv.io/micro_cartan_attn)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [micro_cartan_attn](https://crates.io/crates/micro_cartan_attn)
- **Documentation**: [docs.ruv.io/micro_cartan_attn](https://docs.ruv.io/micro_cartan_attn)
...
![NPM](https://nodei.co/npm/@ruv.io/micro_cartan_attn.png?downloads=true&downloadRank=true&stars=true)
