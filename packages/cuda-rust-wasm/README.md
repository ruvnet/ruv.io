# 🛠️ @ruv.io/cuda-rust-wasm

> CUDA to Rust transpiler with WebGPU/WASM support

[![npm version](https://img.shields.io/npm/v/@ruv.io/cuda-rust-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/cuda-rust-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/cuda-rust-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/cuda-rust-wasm)
[![license](https://img.shields.io/npm/l/@ruv.io/cuda-rust-wasm.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/cuda-rust-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`cuda-rust-wasm`](https://crates.io/crates/cuda-rust-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/cuda-rust-wasm
```

### Using yarn

```bash
yarn add @ruv.io/cuda-rust-wasm
```

### Using pnpm

```bash
pnpm add @ruv.io/cuda-rust-wasm
```
...
- **Linux x64**: `@ruv.io/cuda-rust-wasm-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/cuda-rust-wasm-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/cuda-rust-wasm-darwin-x64`
- **macOS ARM64**: `@ruv.io/cuda-rust-wasm-darwin-arm64`
- **Windows x64**: `@ruv.io/cuda-rust-wasm-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/cuda-rust-wasm-wasm32` (fallback)
...
```typescript
import { CudaRustWasm } from '@ruv.io/cuda-rust-wasm'
...
```typescript
import { CudaRustWasm, Config } from '@ruv.io/cuda-rust-wasm'
...
// CommonJS
const { CudaRustWasm } = require('@ruv.io/cuda-rust-wasm')
```
...
```typescript
import { CudaRustWasm, CudaRustWasmError } from '@ruv.io/cuda-rust-wasm'
...
```typescript
import { CudaRustWasm, Config, LogLevel } from '@ruv.io/cuda-rust-wasm'
...
cd ruv.io/packages/cuda-rust-wasm
...
- **NPM Package**: [@ruv.io/cuda-rust-wasm](https://www.npmjs.com/package/@ruv.io/cuda-rust-wasm)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [cuda-rust-wasm](https://crates.io/crates/cuda-rust-wasm)
- **Documentation**: [docs.ruv.io/cuda-rust-wasm](https://docs.ruv.io/cuda-rust-wasm)
...
![NPM](https://nodei.co/npm/@ruv.io/cuda-rust-wasm.png?downloads=true&downloadRank=true&stars=true)
