# ⏰ @ruv.io/temporal-compare

> High-performance framework for benchmarking temporal prediction algorithms inspired by Time-R1

[![npm version](https://img.shields.io/npm/v/@ruv.io/temporal-compare.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/temporal-compare)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/temporal-compare.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/temporal-compare)
[![license](https://img.shields.io/npm/l/@ruv.io/temporal-compare.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/temporal-compare` is a high-performance Node.js native addon that provides TypeScript bindings for the [`temporal-compare`](https://crates.io/crates/temporal-compare) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/temporal-compare
```

### Using yarn

```bash
yarn add @ruv.io/temporal-compare
```

### Using pnpm

```bash
pnpm add @ruv.io/temporal-compare
```
...
- **Linux x64**: `@ruv.io/temporal-compare-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/temporal-compare-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/temporal-compare-darwin-x64`
- **macOS ARM64**: `@ruv.io/temporal-compare-darwin-arm64`
- **Windows x64**: `@ruv.io/temporal-compare-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/temporal-compare-wasm32` (fallback)
...
```typescript
import { TemporalCompare } from '@ruv.io/temporal-compare'
...
```typescript
import { TemporalCompare, Config } from '@ruv.io/temporal-compare'
...
// CommonJS
const { TemporalCompare } = require('@ruv.io/temporal-compare')
```
...
```typescript
import { TemporalCompare, TemporalCompareError } from '@ruv.io/temporal-compare'
...
```typescript
import { TemporalCompare, Config, LogLevel } from '@ruv.io/temporal-compare'
...
cd ruv.io/packages/temporal-compare
...
- **NPM Package**: [@ruv.io/temporal-compare](https://www.npmjs.com/package/@ruv.io/temporal-compare)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [temporal-compare](https://crates.io/crates/temporal-compare)
- **Documentation**: [docs.ruv.io/temporal-compare](https://docs.ruv.io/temporal-compare)
...
![NPM](https://nodei.co/npm/@ruv.io/temporal-compare.png?downloads=true&downloadRank=true&stars=true)
