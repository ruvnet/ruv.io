# 🧠 @ruv.io/neuro-divergent-training

> Comprehensive training infrastructure for neural forecasting models

[![npm version](https://img.shields.io/npm/v/@ruv.io/neuro-divergent-training.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent-training)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/neuro-divergent-training.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent-training)
[![license](https://img.shields.io/npm/l/@ruv.io/neuro-divergent-training.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/neuro-divergent-training` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent-training`](https://crates.io/crates/neuro-divergent-training) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/neuro-divergent-training
```

### Using yarn

```bash
yarn add @ruv.io/neuro-divergent-training
```

### Using pnpm

```bash
pnpm add @ruv.io/neuro-divergent-training
```
...
- **Linux x64**: `@ruv.io/neuro-divergent-training-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/neuro-divergent-training-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/neuro-divergent-training-darwin-x64`
- **macOS ARM64**: `@ruv.io/neuro-divergent-training-darwin-arm64`
- **Windows x64**: `@ruv.io/neuro-divergent-training-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/neuro-divergent-training-wasm32` (fallback)
...
```typescript
import { NeuroDivergentTraining } from '@ruv.io/neuro-divergent-training'
...
```typescript
import { NeuroDivergentTraining, Config } from '@ruv.io/neuro-divergent-training'
...
// CommonJS
const { NeuroDivergentTraining } = require('@ruv.io/neuro-divergent-training')
```
...
```typescript
import { NeuroDivergentTraining, NeuroDivergentTrainingError } from '@ruv.io/neuro-divergent-training'
...
```typescript
import { NeuroDivergentTraining, Config, LogLevel } from '@ruv.io/neuro-divergent-training'
...
cd ruv.io/packages/neuro-divergent-training
...
- **NPM Package**: [@ruv.io/neuro-divergent-training](https://www.npmjs.com/package/@ruv.io/neuro-divergent-training)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [neuro-divergent-training](https://crates.io/crates/neuro-divergent-training)
- **Documentation**: [docs.ruv.io/neuro-divergent-training](https://docs.ruv.io/neuro-divergent-training)
...
![NPM](https://nodei.co/npm/@ruv.io/neuro-divergent-training.png?downloads=true&downloadRank=true&stars=true)
