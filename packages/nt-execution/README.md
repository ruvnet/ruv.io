...
[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-execution.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-execution)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-execution.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-execution)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-execution.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-execution` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-execution`](https://crates.io/crates/nt-execution) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-execution
```

### Using yarn

```bash
yarn add @ruv.io/nt-execution
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-execution
```
...
- **Linux x64**: `@ruv.io/nt-execution-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-execution-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-execution-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-execution-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-execution-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-execution-wasm32` (fallback)
...
```typescript
import { NtExecution } from '@ruv.io/nt-execution'
...
```typescript
import { NtExecution, Config } from '@ruv.io/nt-execution'
...
// CommonJS
const { NtExecution } = require('@ruv.io/nt-execution')
```
...
```typescript
import { NtExecution, NtExecutionError } from '@ruv.io/nt-execution'
...
```typescript
import { NtExecution, Config, LogLevel } from '@ruv.io/nt-execution'
...
cd ruv.io/packages/nt-execution
...
- **NPM Package**: [@ruv.io/nt-execution](https://www.npmjs.com/package/@ruv.io/nt-execution)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-execution](https://crates.io/crates/nt-execution)
- **Documentation**: [docs.ruv.io/nt-execution](https://docs.ruv.io/nt-execution)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-execution.png?downloads=true&downloadRank=true&stars=true)
