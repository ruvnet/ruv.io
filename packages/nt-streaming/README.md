...
[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-streaming.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-streaming)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-streaming.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-streaming)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-streaming.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-streaming` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-streaming`](https://crates.io/crates/nt-streaming) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-streaming
```

### Using yarn

```bash
yarn add @ruv.io/nt-streaming
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-streaming
```
...
- **Linux x64**: `@ruv.io/nt-streaming-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-streaming-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-streaming-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-streaming-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-streaming-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-streaming-wasm32` (fallback)
...
```typescript
import { NtStreaming } from '@ruv.io/nt-streaming'
...
```typescript
import { NtStreaming, Config } from '@ruv.io/nt-streaming'
...
// CommonJS
const { NtStreaming } = require('@ruv.io/nt-streaming')
```
...
```typescript
import { NtStreaming, NtStreamingError } from '@ruv.io/nt-streaming'
...
```typescript
import { NtStreaming, Config, LogLevel } from '@ruv.io/nt-streaming'
...
cd ruv.io/packages/nt-streaming
...
- **NPM Package**: [@ruv.io/nt-streaming](https://www.npmjs.com/package/@ruv.io/nt-streaming)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-streaming](https://crates.io/crates/nt-streaming)
- **Documentation**: [docs.ruv.io/nt-streaming](https://docs.ruv.io/nt-streaming)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-streaming.png?downloads=true&downloadRank=true&stars=true)
