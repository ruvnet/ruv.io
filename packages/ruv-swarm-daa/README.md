# 🐝 @ruv.io/ruv-swarm-daa

> Decentralized Autonomous Agents (DAA) integration for ruv-swarm

[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-swarm-daa.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-daa)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-swarm-daa.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-daa)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-swarm-daa.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-swarm-daa` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-daa`](https://crates.io/crates/ruv-swarm-daa) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-swarm-daa
```

### Using yarn

```bash
yarn add @ruv.io/ruv-swarm-daa
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-swarm-daa
```
...
- **Linux x64**: `@ruv.io/ruv-swarm-daa-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-swarm-daa-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-swarm-daa-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-swarm-daa-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-swarm-daa-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-swarm-daa-wasm32` (fallback)
...
```typescript
import { RuvSwarmDaa } from '@ruv.io/ruv-swarm-daa'
...
```typescript
import { RuvSwarmDaa, Config } from '@ruv.io/ruv-swarm-daa'
...
// CommonJS
const { RuvSwarmDaa } = require('@ruv.io/ruv-swarm-daa')
```
...
```typescript
import { RuvSwarmDaa, RuvSwarmDaaError } from '@ruv.io/ruv-swarm-daa'
...
```typescript
import { RuvSwarmDaa, Config, LogLevel } from '@ruv.io/ruv-swarm-daa'
...
cd ruv.io/packages/ruv-swarm-daa
...
- **NPM Package**: [@ruv.io/ruv-swarm-daa](https://www.npmjs.com/package/@ruv.io/ruv-swarm-daa)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-swarm-daa](https://crates.io/crates/ruv-swarm-daa)
- **Documentation**: [docs.ruv.io/ruv-swarm-daa](https://docs.ruv.io/ruv-swarm-daa)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-swarm-daa.png?downloads=true&downloadRank=true&stars=true)
