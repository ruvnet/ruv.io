...
[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-ai.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-ai)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-ai.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-ai)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-ai.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-ai` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-ai`](https://crates.io/crates/daa-ai) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-ai
```

### Using yarn

```bash
yarn add @ruv.io/daa-ai
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-ai
```
...
- **Linux x64**: `@ruv.io/daa-ai-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-ai-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-ai-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-ai-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-ai-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-ai-wasm32` (fallback)
...
```typescript
import { DaaAi } from '@ruv.io/daa-ai'
...
```typescript
import { DaaAi, Config } from '@ruv.io/daa-ai'
...
// CommonJS
const { DaaAi } = require('@ruv.io/daa-ai')
```
...
```typescript
import { DaaAi, DaaAiError } from '@ruv.io/daa-ai'
...
```typescript
import { DaaAi, Config, LogLevel } from '@ruv.io/daa-ai'
...
- **NPM Package**: [@ruv.io/daa-ai](https://www.npmjs.com/package/@ruv.io/daa-ai)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-ai](https://crates.io/crates/daa-ai)
- **Documentation**: [docs.ruv.io/daa-ai](https://docs.ruv.io/daa-ai)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-ai.png?downloads=true&downloadRank=true&stars=true)
