...
[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-core)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-core`](https://crates.io/crates/nt-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-core
```

### Using yarn

```bash
yarn add @ruv.io/nt-core
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-core
```
...
- **Linux x64**: `@ruv.io/nt-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-core-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-core-wasm32` (fallback)
...
```typescript
import { NtCore } from '@ruv.io/nt-core'
...
```typescript
import { NtCore, Config } from '@ruv.io/nt-core'
...
// CommonJS
const { NtCore } = require('@ruv.io/nt-core')
```
...
```typescript
import { NtCore, NtCoreError } from '@ruv.io/nt-core'
...
```typescript
import { NtCore, Config, LogLevel } from '@ruv.io/nt-core'
...
- **NPM Package**: [@ruv.io/nt-core](https://www.npmjs.com/package/@ruv.io/nt-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-core](https://crates.io/crates/nt-core)
- **Documentation**: [docs.ruv.io/nt-core](https://docs.ruv.io/nt-core)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-core.png?downloads=true&downloadRank=true&stars=true)
