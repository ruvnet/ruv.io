# ⚛️ @ruv.io/synaptic-qudag-core

> QuDAG core networking for Synaptic Neural Mesh - DAG-based consensus and P2P networking

[![npm version](https://img.shields.io/npm/v/@ruv.io/synaptic-qudag-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/synaptic-qudag-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/synaptic-qudag-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/synaptic-qudag-core)
[![license](https://img.shields.io/npm/l/@ruv.io/synaptic-qudag-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/synaptic-qudag-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`synaptic-qudag-core`](https://crates.io/crates/synaptic-qudag-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/synaptic-qudag-core
```

### Using yarn

```bash
yarn add @ruv.io/synaptic-qudag-core
```

### Using pnpm

```bash
pnpm add @ruv.io/synaptic-qudag-core
```
...
- **Linux x64**: `@ruv.io/synaptic-qudag-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/synaptic-qudag-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/synaptic-qudag-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/synaptic-qudag-core-darwin-arm64`
- **Windows x64**: `@ruv.io/synaptic-qudag-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/synaptic-qudag-core-wasm32` (fallback)
...
```typescript
import { SynapticQudagCore } from '@ruv.io/synaptic-qudag-core'
...
```typescript
import { SynapticQudagCore, Config } from '@ruv.io/synaptic-qudag-core'
...
// CommonJS
const { SynapticQudagCore } = require('@ruv.io/synaptic-qudag-core')
```
...
```typescript
import { SynapticQudagCore, SynapticQudagCoreError } from '@ruv.io/synaptic-qudag-core'
...
```typescript
import { SynapticQudagCore, Config, LogLevel } from '@ruv.io/synaptic-qudag-core'
...
cd ruv.io/packages/synaptic-qudag-core
...
- **NPM Package**: [@ruv.io/synaptic-qudag-core](https://www.npmjs.com/package/@ruv.io/synaptic-qudag-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [synaptic-qudag-core](https://crates.io/crates/synaptic-qudag-core)
- **Documentation**: [docs.ruv.io/synaptic-qudag-core](https://docs.ruv.io/synaptic-qudag-core)
...
![NPM](https://nodei.co/npm/@ruv.io/synaptic-qudag-core.png?downloads=true&downloadRank=true&stars=true)
