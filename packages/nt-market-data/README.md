# 📦 @ruv.io/nt-market-data

> Market data providers and streaming for Neural Trader - supports Alpaca, Polygon, IEX, and more

[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-market-data.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-market-data)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-market-data.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-market-data)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-market-data.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-market-data` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-market-data`](https://crates.io/crates/nt-market-data) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-market-data
```

### Using yarn

```bash
yarn add @ruv.io/nt-market-data
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-market-data
```
...
- **Linux x64**: `@ruv.io/nt-market-data-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-market-data-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-market-data-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-market-data-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-market-data-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-market-data-wasm32` (fallback)
...
```typescript
import { NtMarketData } from '@ruv.io/nt-market-data'
...
```typescript
import { NtMarketData, Config } from '@ruv.io/nt-market-data'
...
// CommonJS
const { NtMarketData } = require('@ruv.io/nt-market-data')
```
...
```typescript
import { NtMarketData, NtMarketDataError } from '@ruv.io/nt-market-data'
...
```typescript
import { NtMarketData, Config, LogLevel } from '@ruv.io/nt-market-data'
...
cd ruv.io/packages/nt-market-data
...
- **NPM Package**: [@ruv.io/nt-market-data](https://www.npmjs.com/package/@ruv.io/nt-market-data)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-market-data](https://crates.io/crates/nt-market-data)
- **Documentation**: [docs.ruv.io/nt-market-data](https://docs.ruv.io/nt-market-data)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-market-data.png?downloads=true&downloadRank=true&stars=true)
