...
[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qudag` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag`](https://crates.io/crates/qudag) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qudag
```

### Using yarn

```bash
yarn add @ruv.io/qudag
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag
```
...
- **Linux x64**: `@ruv.io/qudag-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-wasm32` (fallback)
...
```typescript
import { Qudag } from '@ruv.io/qudag'
...
```typescript
import { Qudag, Config } from '@ruv.io/qudag'
...
// CommonJS
const { Qudag } = require('@ruv.io/qudag')
```
...
```typescript
import { Qudag, QudagError } from '@ruv.io/qudag'
...
```typescript
import { Qudag, Config, LogLevel } from '@ruv.io/qudag'
...
- **NPM Package**: [@ruv.io/qudag](https://www.npmjs.com/package/@ruv.io/qudag)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag](https://crates.io/crates/qudag)
- **Documentation**: [docs.ruv.io/qudag](https://docs.ruv.io/qudag)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag.png?downloads=true&downloadRank=true&stars=true)
