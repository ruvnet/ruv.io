# 🐝 @ruv.io/code-mesh-wasm

> WebAssembly bindings for the Code-Mesh distributed swarm intelligence system

[![npm version](https://img.shields.io/npm/v/@ruv.io/code-mesh-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/code-mesh-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/code-mesh-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/code-mesh-wasm)
[![license](https://img.shields.io/npm/l/@ruv.io/code-mesh-wasm.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/code-mesh-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`code-mesh-wasm`](https://crates.io/crates/code-mesh-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/code-mesh-wasm
```

### Using yarn

```bash
yarn add @ruv.io/code-mesh-wasm
```

### Using pnpm

```bash
pnpm add @ruv.io/code-mesh-wasm
```
...
- **Linux x64**: `@ruv.io/code-mesh-wasm-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/code-mesh-wasm-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/code-mesh-wasm-darwin-x64`
- **macOS ARM64**: `@ruv.io/code-mesh-wasm-darwin-arm64`
- **Windows x64**: `@ruv.io/code-mesh-wasm-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/code-mesh-wasm-wasm32` (fallback)
...
```typescript
import { CodeMeshWasm } from '@ruv.io/code-mesh-wasm'
...
```typescript
import { CodeMeshWasm, Config } from '@ruv.io/code-mesh-wasm'
...
// CommonJS
const { CodeMeshWasm } = require('@ruv.io/code-mesh-wasm')
```
...
```typescript
import { CodeMeshWasm, CodeMeshWasmError } from '@ruv.io/code-mesh-wasm'
...
```typescript
import { CodeMeshWasm, Config, LogLevel } from '@ruv.io/code-mesh-wasm'
...
cd ruv.io/packages/code-mesh-wasm
...
- **NPM Package**: [@ruv.io/code-mesh-wasm](https://www.npmjs.com/package/@ruv.io/code-mesh-wasm)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [code-mesh-wasm](https://crates.io/crates/code-mesh-wasm)
- **Documentation**: [docs.ruv.io/code-mesh-wasm](https://docs.ruv.io/code-mesh-wasm)
...
![NPM](https://nodei.co/npm/@ruv.io/code-mesh-wasm.png?downloads=true&downloadRank=true&stars=true)
