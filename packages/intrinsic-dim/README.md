# 📐 @ruv.io/intrinsic-dim

> Fast intrinsic dimensionality estimation for ML model optimization

[![npm version](https://img.shields.io/npm/v/@ruv.io/intrinsic-dim.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/intrinsic-dim)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/intrinsic-dim.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/intrinsic-dim)
[![license](https://img.shields.io/npm/l/@ruv.io/intrinsic-dim.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/intrinsic-dim` is a high-performance Node.js native addon that provides TypeScript bindings for the [`intrinsic-dim`](https://crates.io/crates/intrinsic-dim) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/intrinsic-dim
```

### Using yarn

```bash
yarn add @ruv.io/intrinsic-dim
```

### Using pnpm

```bash
pnpm add @ruv.io/intrinsic-dim
```
...
- **Linux x64**: `@ruv.io/intrinsic-dim-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/intrinsic-dim-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/intrinsic-dim-darwin-x64`
- **macOS ARM64**: `@ruv.io/intrinsic-dim-darwin-arm64`
- **Windows x64**: `@ruv.io/intrinsic-dim-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/intrinsic-dim-wasm32` (fallback)
...
```typescript
import { IntrinsicDim } from '@ruv.io/intrinsic-dim'
...
```typescript
import { IntrinsicDim, Config } from '@ruv.io/intrinsic-dim'
...
// CommonJS
const { IntrinsicDim } = require('@ruv.io/intrinsic-dim')
```
...
```typescript
import { IntrinsicDim, IntrinsicDimError } from '@ruv.io/intrinsic-dim'
...
```typescript
import { IntrinsicDim, Config, LogLevel } from '@ruv.io/intrinsic-dim'
...
cd ruv.io/packages/intrinsic-dim
...
- **NPM Package**: [@ruv.io/intrinsic-dim](https://www.npmjs.com/package/@ruv.io/intrinsic-dim)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [intrinsic-dim](https://crates.io/crates/intrinsic-dim)
- **Documentation**: [docs.ruv.io/intrinsic-dim](https://docs.ruv.io/intrinsic-dim)
...
![NPM](https://nodei.co/npm/@ruv.io/intrinsic-dim.png?downloads=true&downloadRank=true&stars=true)
