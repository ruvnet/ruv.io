# 🧠 @ruv.io/micro_metrics

> Performance monitoring and metrics collection for micro-neural networks

[![npm version](https://img.shields.io/npm/v/@ruv.io/micro_metrics.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_metrics)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/micro_metrics.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_metrics)
[![license](https://img.shields.io/npm/l/@ruv.io/micro_metrics.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/micro_metrics` is a high-performance Node.js native addon that provides TypeScript bindings for the [`micro_metrics`](https://crates.io/crates/micro_metrics) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/micro_metrics
```

### Using yarn

```bash
yarn add @ruv.io/micro_metrics
```

### Using pnpm

```bash
pnpm add @ruv.io/micro_metrics
```
...
- **Linux x64**: `@ruv.io/micro_metrics-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/micro_metrics-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/micro_metrics-darwin-x64`
- **macOS ARM64**: `@ruv.io/micro_metrics-darwin-arm64`
- **Windows x64**: `@ruv.io/micro_metrics-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/micro_metrics-wasm32` (fallback)
...
```typescript
import { Micro_metrics } from '@ruv.io/micro_metrics'
...
```typescript
import { Micro_metrics, Config } from '@ruv.io/micro_metrics'
...
// CommonJS
const { Micro_metrics } = require('@ruv.io/micro_metrics')
```
...
```typescript
import { Micro_metrics, Micro_metricsError } from '@ruv.io/micro_metrics'
...
```typescript
import { Micro_metrics, Config, LogLevel } from '@ruv.io/micro_metrics'
...
cd ruv.io/packages/micro_metrics
...
- **NPM Package**: [@ruv.io/micro_metrics](https://www.npmjs.com/package/@ruv.io/micro_metrics)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [micro_metrics](https://crates.io/crates/micro_metrics)
- **Documentation**: [docs.ruv.io/micro_metrics](https://docs.ruv.io/micro_metrics)
...
![NPM](https://nodei.co/npm/@ruv.io/micro_metrics.png?downloads=true&downloadRank=true&stars=true)
