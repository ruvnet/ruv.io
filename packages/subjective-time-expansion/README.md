# ⏰ @ruv.io/subjective-time-expansion
...
[![npm version](https://img.shields.io/npm/v/@ruv.io/subjective-time-expansion.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/subjective-time-expansion)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/subjective-time-expansion.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/subjective-time-expansion)
[![license](https://img.shields.io/npm/l/@ruv.io/subjective-time-expansion.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/subjective-time-expansion` is a high-performance Node.js native addon that provides TypeScript bindings for the [`subjective-time-expansion`](https://crates.io/crates/subjective-time-expansion) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/subjective-time-expansion
```

### Using yarn

```bash
yarn add @ruv.io/subjective-time-expansion
```

### Using pnpm

```bash
pnpm add @ruv.io/subjective-time-expansion
```
...
- **Linux x64**: `@ruv.io/subjective-time-expansion-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/subjective-time-expansion-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/subjective-time-expansion-darwin-x64`
- **macOS ARM64**: `@ruv.io/subjective-time-expansion-darwin-arm64`
- **Windows x64**: `@ruv.io/subjective-time-expansion-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/subjective-time-expansion-wasm32` (fallback)
...
```typescript
import { SubjectiveTimeExpansion } from '@ruv.io/subjective-time-expansion'
...
```typescript
import { SubjectiveTimeExpansion, Config } from '@ruv.io/subjective-time-expansion'
...
// CommonJS
const { SubjectiveTimeExpansion } = require('@ruv.io/subjective-time-expansion')
```
...
```typescript
import { SubjectiveTimeExpansion, SubjectiveTimeExpansionError } from '@ruv.io/subjective-time-expansion'
...
```typescript
import { SubjectiveTimeExpansion, Config, LogLevel } from '@ruv.io/subjective-time-expansion'
...
cd ruv.io/packages/subjective-time-expansion
...
- **NPM Package**: [@ruv.io/subjective-time-expansion](https://www.npmjs.com/package/@ruv.io/subjective-time-expansion)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [subjective-time-expansion](https://crates.io/crates/subjective-time-expansion)
- **Documentation**: [docs.ruv.io/subjective-time-expansion](https://docs.ruv.io/subjective-time-expansion)
...
![NPM](https://nodei.co/npm/@ruv.io/subjective-time-expansion.png?downloads=true&downloadRank=true&stars=true)
