...
[![npm version](https://img.shields.io/npm/v/@ruv.io/veritas-nexus.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/veritas-nexus)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/veritas-nexus.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/veritas-nexus)
[![license](https://img.shields.io/npm/l/@ruv.io/veritas-nexus.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/veritas-nexus` is a high-performance Node.js native addon that provides TypeScript bindings for the [`veritas-nexus`](https://crates.io/crates/veritas-nexus) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/veritas-nexus
```

### Using yarn

```bash
yarn add @ruv.io/veritas-nexus
```

### Using pnpm

```bash
pnpm add @ruv.io/veritas-nexus
```
...
- **Linux x64**: `@ruv.io/veritas-nexus-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/veritas-nexus-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/veritas-nexus-darwin-x64`
- **macOS ARM64**: `@ruv.io/veritas-nexus-darwin-arm64`
- **Windows x64**: `@ruv.io/veritas-nexus-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/veritas-nexus-wasm32` (fallback)
...
```typescript
import { VeritasNexus } from '@ruv.io/veritas-nexus'
...
```typescript
import { VeritasNexus, Config } from '@ruv.io/veritas-nexus'
...
// CommonJS
const { VeritasNexus } = require('@ruv.io/veritas-nexus')
```
...
```typescript
import { VeritasNexus, VeritasNexusError } from '@ruv.io/veritas-nexus'
...
```typescript
import { VeritasNexus, Config, LogLevel } from '@ruv.io/veritas-nexus'
...
cd ruv.io/packages/veritas-nexus
...
- **NPM Package**: [@ruv.io/veritas-nexus](https://www.npmjs.com/package/@ruv.io/veritas-nexus)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [veritas-nexus](https://crates.io/crates/veritas-nexus)
- **Documentation**: [docs.ruv.io/veritas-nexus](https://docs.ruv.io/veritas-nexus)
...
![NPM](https://nodei.co/npm/@ruv.io/veritas-nexus.png?downloads=true&downloadRank=true&stars=true)
