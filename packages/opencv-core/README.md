# 👁️ @ruv.io/opencv-core

> OpenCV Core module - fundamental data structures and operations

[![npm version](https://img.shields.io/npm/v/@ruv.io/opencv-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/opencv-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/opencv-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/opencv-core)
[![license](https://img.shields.io/npm/l/@ruv.io/opencv-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/opencv-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`opencv-core`](https://crates.io/crates/opencv-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/opencv-core
```

### Using yarn

```bash
yarn add @ruv.io/opencv-core
```

### Using pnpm

```bash
pnpm add @ruv.io/opencv-core
```
...
- **Linux x64**: `@ruv.io/opencv-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/opencv-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/opencv-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/opencv-core-darwin-arm64`
- **Windows x64**: `@ruv.io/opencv-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/opencv-core-wasm32` (fallback)
...
```typescript
import { OpencvCore } from '@ruv.io/opencv-core'
...
```typescript
import { OpencvCore, Config } from '@ruv.io/opencv-core'
...
// CommonJS
const { OpencvCore } = require('@ruv.io/opencv-core')
```
...
```typescript
import { OpencvCore, OpencvCoreError } from '@ruv.io/opencv-core'
...
```typescript
import { OpencvCore, Config, LogLevel } from '@ruv.io/opencv-core'
...
cd ruv.io/packages/opencv-core
...
- **NPM Package**: [@ruv.io/opencv-core](https://www.npmjs.com/package/@ruv.io/opencv-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [opencv-core](https://crates.io/crates/opencv-core)
- **Documentation**: [docs.ruv.io/opencv-core](https://docs.ruv.io/opencv-core)
...
![NPM](https://nodei.co/npm/@ruv.io/opencv-core.png?downloads=true&downloadRank=true&stars=true)
