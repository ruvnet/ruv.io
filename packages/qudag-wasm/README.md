...
[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-wasm)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag-wasm.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qudag-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-wasm`](https://crates.io/crates/qudag-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qudag-wasm
```

### Using yarn

```bash
yarn add @ruv.io/qudag-wasm
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag-wasm
```
...
- **Linux x64**: `@ruv.io/qudag-wasm-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-wasm-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-wasm-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-wasm-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-wasm-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-wasm-wasm32` (fallback)
...
```typescript
import { QudagWasm } from '@ruv.io/qudag-wasm'
...
```typescript
import { QudagWasm, Config } from '@ruv.io/qudag-wasm'
...
// CommonJS
const { QudagWasm } = require('@ruv.io/qudag-wasm')
```
...
```typescript
import { QudagWasm, QudagWasmError } from '@ruv.io/qudag-wasm'
...
```typescript
import { QudagWasm, Config, LogLevel } from '@ruv.io/qudag-wasm'
...
- **NPM Package**: [@ruv.io/qudag-wasm](https://www.npmjs.com/package/@ruv.io/qudag-wasm)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag-wasm](https://crates.io/crates/qudag-wasm)
- **Documentation**: [docs.ruv.io/qudag-wasm](https://docs.ruv.io/qudag-wasm)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag-wasm.png?downloads=true&downloadRank=true&stars=true)
