...
[![npm version](https://img.shields.io/npm/v/@ruv.io/lean-agentic.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/lean-agentic)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/lean-agentic.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/lean-agentic)
[![license](https://img.shields.io/npm/l/@ruv.io/lean-agentic.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/lean-agentic` is a high-performance Node.js native addon that provides TypeScript bindings for the [`lean-agentic`](https://crates.io/crates/lean-agentic) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/lean-agentic
```

### Using yarn

```bash
yarn add @ruv.io/lean-agentic
```

### Using pnpm

```bash
pnpm add @ruv.io/lean-agentic
```
...
- **Linux x64**: `@ruv.io/lean-agentic-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/lean-agentic-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/lean-agentic-darwin-x64`
- **macOS ARM64**: `@ruv.io/lean-agentic-darwin-arm64`
- **Windows x64**: `@ruv.io/lean-agentic-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/lean-agentic-wasm32` (fallback)
...
```typescript
import { LeanAgentic } from '@ruv.io/lean-agentic'
...
```typescript
import { LeanAgentic, Config } from '@ruv.io/lean-agentic'
...
// CommonJS
const { LeanAgentic } = require('@ruv.io/lean-agentic')
```
...
```typescript
import { LeanAgentic, LeanAgenticError } from '@ruv.io/lean-agentic'
...
```typescript
import { LeanAgentic, Config, LogLevel } from '@ruv.io/lean-agentic'
...
cd ruv.io/packages/lean-agentic
...
- **NPM Package**: [@ruv.io/lean-agentic](https://www.npmjs.com/package/@ruv.io/lean-agentic)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [lean-agentic](https://crates.io/crates/lean-agentic)
- **Documentation**: [docs.ruv.io/lean-agentic](https://docs.ruv.io/lean-agentic)
...
![NPM](https://nodei.co/npm/@ruv.io/lean-agentic.png?downloads=true&downloadRank=true&stars=true)
