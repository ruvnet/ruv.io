...
[![npm version](https://img.shields.io/npm/v/@ruv.io/micro_swarm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_swarm)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/micro_swarm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_swarm)
[![license](https://img.shields.io/npm/l/@ruv.io/micro_swarm.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/micro_swarm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`micro_swarm`](https://crates.io/crates/micro_swarm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/micro_swarm
```

### Using yarn

```bash
yarn add @ruv.io/micro_swarm
```

### Using pnpm

```bash
pnpm add @ruv.io/micro_swarm
```
...
- **Linux x64**: `@ruv.io/micro_swarm-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/micro_swarm-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/micro_swarm-darwin-x64`
- **macOS ARM64**: `@ruv.io/micro_swarm-darwin-arm64`
- **Windows x64**: `@ruv.io/micro_swarm-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/micro_swarm-wasm32` (fallback)
...
```typescript
import { Micro_swarm } from '@ruv.io/micro_swarm'
...
```typescript
import { Micro_swarm, Config } from '@ruv.io/micro_swarm'
...
// CommonJS
const { Micro_swarm } = require('@ruv.io/micro_swarm')
```
...
```typescript
import { Micro_swarm, Micro_swarmError } from '@ruv.io/micro_swarm'
...
```typescript
import { Micro_swarm, Config, LogLevel } from '@ruv.io/micro_swarm'
...
cd ruv.io/packages/micro_swarm
...
- **NPM Package**: [@ruv.io/micro_swarm](https://www.npmjs.com/package/@ruv.io/micro_swarm)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [micro_swarm](https://crates.io/crates/micro_swarm)
- **Documentation**: [docs.ruv.io/micro_swarm](https://docs.ruv.io/micro_swarm)
...
![NPM](https://nodei.co/npm/@ruv.io/micro_swarm.png?downloads=true&downloadRank=true&stars=true)
