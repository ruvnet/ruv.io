# 🛠️ @ruv.io/claude-parser

> Claude Code CLI stream-JSON parser for ruv-swarm multi-agent orchestration

[![npm version](https://img.shields.io/npm/v/@ruv.io/claude-parser.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/claude-parser)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/claude-parser.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/claude-parser)
[![license](https://img.shields.io/npm/l/@ruv.io/claude-parser.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/claude-parser` is a high-performance Node.js native addon that provides TypeScript bindings for the [`claude-parser`](https://crates.io/crates/claude-parser) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/claude-parser
```

### Using yarn

```bash
yarn add @ruv.io/claude-parser
```

### Using pnpm

```bash
pnpm add @ruv.io/claude-parser
```
...
- **Linux x64**: `@ruv.io/claude-parser-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/claude-parser-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/claude-parser-darwin-x64`
- **macOS ARM64**: `@ruv.io/claude-parser-darwin-arm64`
- **Windows x64**: `@ruv.io/claude-parser-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/claude-parser-wasm32` (fallback)
...
```typescript
import { ClaudeParser } from '@ruv.io/claude-parser'
...
```typescript
import { ClaudeParser, Config } from '@ruv.io/claude-parser'
...
// CommonJS
const { ClaudeParser } = require('@ruv.io/claude-parser')
```
...
```typescript
import { ClaudeParser, ClaudeParserError } from '@ruv.io/claude-parser'
...
```typescript
import { ClaudeParser, Config, LogLevel } from '@ruv.io/claude-parser'
...
cd ruv.io/packages/claude-parser
...
- **NPM Package**: [@ruv.io/claude-parser](https://www.npmjs.com/package/@ruv.io/claude-parser)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [claude-parser](https://crates.io/crates/claude-parser)
- **Documentation**: [docs.ruv.io/claude-parser](https://docs.ruv.io/claude-parser)
...
![NPM](https://nodei.co/npm/@ruv.io/claude-parser.png?downloads=true&downloadRank=true&stars=true)
