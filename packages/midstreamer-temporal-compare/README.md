# ⏰ @ruv.io/midstreamer-temporal-compare

> Temporal sequence comparison and pattern matching

[![npm version](https://img.shields.io/npm/v/@ruv.io/midstreamer-temporal-compare.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-temporal-compare)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/midstreamer-temporal-compare.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-temporal-compare)
[![license](https://img.shields.io/npm/l/@ruv.io/midstreamer-temporal-compare.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
```bash
npm install @ruv.io/midstreamer-temporal-compare
```

### Using yarn

```bash
yarn add @ruv.io/midstreamer-temporal-compare
```

### Using pnpm

```bash
pnpm add @ruv.io/midstreamer-temporal-compare
```
...
- **Linux x64**: `@ruv.io/midstreamer-temporal-compare-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/midstreamer-temporal-compare-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/midstreamer-temporal-compare-darwin-x64`
- **macOS ARM64**: `@ruv.io/midstreamer-temporal-compare-darwin-arm64`
- **Windows x64**: `@ruv.io/midstreamer-temporal-compare-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/midstreamer-temporal-compare-wasm32` (fallback)
...
```typescript
import { MidstreamerTemporalCompare } from '@ruv.io/midstreamer-temporal-compare'
...
```typescript
import { MidstreamerTemporalCompare, Config } from '@ruv.io/midstreamer-temporal-compare'
...
// CommonJS
const { MidstreamerTemporalCompare } = require('@ruv.io/midstreamer-temporal-compare')
```
...
```typescript
import { MidstreamerTemporalCompare, MidstreamerTemporalCompareError } from '@ruv.io/midstreamer-temporal-compare'
...
```typescript
import { MidstreamerTemporalCompare, Config, LogLevel } from '@ruv.io/midstreamer-temporal-compare'
...
cd ruv.io/packages/midstreamer-temporal-compare
...
- **NPM Package**: [@ruv.io/midstreamer-temporal-compare](https://www.npmjs.com/package/@ruv.io/midstreamer-temporal-compare)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [midstreamer-temporal-compare](https://crates.io/crates/midstreamer-temporal-compare)
- **Documentation**: [docs.ruv.io/midstreamer-temporal-compare](https://docs.ruv.io/midstreamer-temporal-compare)
...
![NPM](https://nodei.co/npm/@ruv.io/midstreamer-temporal-compare.png?downloads=true&downloadRank=true&stars=true)
