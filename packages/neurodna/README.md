...
[![npm version](https://img.shields.io/npm/v/@ruv.io/neurodna.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neurodna)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/neurodna.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neurodna)
[![license](https://img.shields.io/npm/l/@ruv.io/neurodna.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/neurodna` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neurodna`](https://crates.io/crates/neurodna) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/neurodna
```

### Using yarn

```bash
yarn add @ruv.io/neurodna
```

### Using pnpm

```bash
pnpm add @ruv.io/neurodna
```
...
- **Linux x64**: `@ruv.io/neurodna-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/neurodna-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/neurodna-darwin-x64`
- **macOS ARM64**: `@ruv.io/neurodna-darwin-arm64`
- **Windows x64**: `@ruv.io/neurodna-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/neurodna-wasm32` (fallback)
...
```typescript
import { Neurodna } from '@ruv.io/neurodna'
...
```typescript
import { Neurodna, Config } from '@ruv.io/neurodna'
...
// CommonJS
const { Neurodna } = require('@ruv.io/neurodna')
```
...
```typescript
import { Neurodna, NeurodnaError } from '@ruv.io/neurodna'
...
```typescript
import { Neurodna, Config, LogLevel } from '@ruv.io/neurodna'
...
- **NPM Package**: [@ruv.io/neurodna](https://www.npmjs.com/package/@ruv.io/neurodna)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [neurodna](https://crates.io/crates/neurodna)
- **Documentation**: [docs.ruv.io/neurodna](https://docs.ruv.io/neurodna)
...
![NPM](https://nodei.co/npm/@ruv.io/neurodna.png?downloads=true&downloadRank=true&stars=true)
