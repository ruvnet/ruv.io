...
[![npm version](https://img.shields.io/npm/v/@ruv.io/sublinear.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/sublinear)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/sublinear.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/sublinear)
[![license](https://img.shields.io/npm/l/@ruv.io/sublinear.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/sublinear` is a high-performance Node.js native addon that provides TypeScript bindings for the [`sublinear`](https://crates.io/crates/sublinear) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/sublinear
```

### Using yarn

```bash
yarn add @ruv.io/sublinear
```

### Using pnpm

```bash
pnpm add @ruv.io/sublinear
```
...
- **Linux x64**: `@ruv.io/sublinear-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/sublinear-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/sublinear-darwin-x64`
- **macOS ARM64**: `@ruv.io/sublinear-darwin-arm64`
- **Windows x64**: `@ruv.io/sublinear-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/sublinear-wasm32` (fallback)
...
```typescript
import { Sublinear } from '@ruv.io/sublinear'
...
```typescript
import { Sublinear, Config } from '@ruv.io/sublinear'
...
// CommonJS
const { Sublinear } = require('@ruv.io/sublinear')
```
...
```typescript
import { Sublinear, SublinearError } from '@ruv.io/sublinear'
...
```typescript
import { Sublinear, Config, LogLevel } from '@ruv.io/sublinear'
...
- **NPM Package**: [@ruv.io/sublinear](https://www.npmjs.com/package/@ruv.io/sublinear)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [sublinear](https://crates.io/crates/sublinear)
- **Documentation**: [docs.ruv.io/sublinear](https://docs.ruv.io/sublinear)
...
![NPM](https://nodei.co/npm/@ruv.io/sublinear.png?downloads=true&downloadRank=true&stars=true)
