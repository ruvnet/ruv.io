# 📦 @ruv.io/daa-orchestrator

> Core orchestration engine for DAA system implementing autonomy loops

[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-orchestrator.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-orchestrator)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-orchestrator.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-orchestrator)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-orchestrator.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-orchestrator` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-orchestrator`](https://crates.io/crates/daa-orchestrator) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-orchestrator
```

### Using yarn

```bash
yarn add @ruv.io/daa-orchestrator
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-orchestrator
```
...
- **Linux x64**: `@ruv.io/daa-orchestrator-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-orchestrator-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-orchestrator-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-orchestrator-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-orchestrator-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-orchestrator-wasm32` (fallback)
...
```typescript
import { DaaOrchestrator } from '@ruv.io/daa-orchestrator'
...
```typescript
import { DaaOrchestrator, Config } from '@ruv.io/daa-orchestrator'
...
// CommonJS
const { DaaOrchestrator } = require('@ruv.io/daa-orchestrator')
```
...
```typescript
import { DaaOrchestrator, DaaOrchestratorError } from '@ruv.io/daa-orchestrator'
...
```typescript
import { DaaOrchestrator, Config, LogLevel } from '@ruv.io/daa-orchestrator'
...
cd ruv.io/packages/daa-orchestrator
...
- **NPM Package**: [@ruv.io/daa-orchestrator](https://www.npmjs.com/package/@ruv.io/daa-orchestrator)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-orchestrator](https://crates.io/crates/daa-orchestrator)
- **Documentation**: [docs.ruv.io/daa-orchestrator](https://docs.ruv.io/daa-orchestrator)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-orchestrator.png?downloads=true&downloadRank=true&stars=true)
