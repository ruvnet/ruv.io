# 🐝 @ruv.io/ruv-swarm-core

> Core orchestration and agent traits for RUV Swarm

[![npm version](https://img.shields.io/npm/v/@ruv.io/ruv-swarm-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/ruv-swarm-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/ruv-swarm-core)
[![license](https://img.shields.io/npm/l/@ruv.io/ruv-swarm-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/ruv-swarm-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`ruv-swarm-core`](https://crates.io/crates/ruv-swarm-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/ruv-swarm-core
```

### Using yarn

```bash
yarn add @ruv.io/ruv-swarm-core
```

### Using pnpm

```bash
pnpm add @ruv.io/ruv-swarm-core
```
...
- **Linux x64**: `@ruv.io/ruv-swarm-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/ruv-swarm-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/ruv-swarm-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/ruv-swarm-core-darwin-arm64`
- **Windows x64**: `@ruv.io/ruv-swarm-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/ruv-swarm-core-wasm32` (fallback)
...
```typescript
import { RuvSwarmCore } from '@ruv.io/ruv-swarm-core'
...
```typescript
import { RuvSwarmCore, Config } from '@ruv.io/ruv-swarm-core'
...
// CommonJS
const { RuvSwarmCore } = require('@ruv.io/ruv-swarm-core')
```
...
```typescript
import { RuvSwarmCore, RuvSwarmCoreError } from '@ruv.io/ruv-swarm-core'
...
```typescript
import { RuvSwarmCore, Config, LogLevel } from '@ruv.io/ruv-swarm-core'
...
cd ruv.io/packages/ruv-swarm-core
...
- **NPM Package**: [@ruv.io/ruv-swarm-core](https://www.npmjs.com/package/@ruv.io/ruv-swarm-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [ruv-swarm-core](https://crates.io/crates/ruv-swarm-core)
- **Documentation**: [docs.ruv.io/ruv-swarm-core](https://docs.ruv.io/ruv-swarm-core)
...
![NPM](https://nodei.co/npm/@ruv.io/ruv-swarm-core.png?downloads=true&downloadRank=true&stars=true)
