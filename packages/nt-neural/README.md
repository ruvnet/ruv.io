...
[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-neural.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-neural)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-neural.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-neural)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-neural.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-neural` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-neural`](https://crates.io/crates/nt-neural) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-neural
```

### Using yarn

```bash
yarn add @ruv.io/nt-neural
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-neural
```
...
- **Linux x64**: `@ruv.io/nt-neural-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-neural-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-neural-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-neural-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-neural-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-neural-wasm32` (fallback)
...
```typescript
import { NtNeural } from '@ruv.io/nt-neural'
...
```typescript
import { NtNeural, Config } from '@ruv.io/nt-neural'
...
// CommonJS
const { NtNeural } = require('@ruv.io/nt-neural')
```
...
```typescript
import { NtNeural, NtNeuralError } from '@ruv.io/nt-neural'
...
```typescript
import { NtNeural, Config, LogLevel } from '@ruv.io/nt-neural'
...
- **NPM Package**: [@ruv.io/nt-neural](https://www.npmjs.com/package/@ruv.io/nt-neural)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-neural](https://crates.io/crates/nt-neural)
- **Documentation**: [docs.ruv.io/nt-neural](https://docs.ruv.io/nt-neural)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-neural.png?downloads=true&downloadRank=true&stars=true)
