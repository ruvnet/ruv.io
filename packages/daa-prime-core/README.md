# 📦 @ruv.io/daa-prime-core

> Core shared structures and protocol definitions for Prime distributed ML framework

[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-prime-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-prime-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-prime-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-prime-core)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-prime-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-prime-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-prime-core`](https://crates.io/crates/daa-prime-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-prime-core
```

### Using yarn

```bash
yarn add @ruv.io/daa-prime-core
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-prime-core
```
...
- **Linux x64**: `@ruv.io/daa-prime-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-prime-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-prime-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-prime-core-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-prime-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-prime-core-wasm32` (fallback)
...
```typescript
import { DaaPrimeCore } from '@ruv.io/daa-prime-core'
...
```typescript
import { DaaPrimeCore, Config } from '@ruv.io/daa-prime-core'
...
// CommonJS
const { DaaPrimeCore } = require('@ruv.io/daa-prime-core')
```
...
```typescript
import { DaaPrimeCore, DaaPrimeCoreError } from '@ruv.io/daa-prime-core'
...
```typescript
import { DaaPrimeCore, Config, LogLevel } from '@ruv.io/daa-prime-core'
...
cd ruv.io/packages/daa-prime-core
...
- **NPM Package**: [@ruv.io/daa-prime-core](https://www.npmjs.com/package/@ruv.io/daa-prime-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-prime-core](https://crates.io/crates/daa-prime-core)
- **Documentation**: [docs.ruv.io/daa-prime-core](https://docs.ruv.io/daa-prime-core)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-prime-core.png?downloads=true&downloadRank=true&stars=true)
