...
[![npm version](https://img.shields.io/npm/v/@ruv.io/neuro-divergent.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/neuro-divergent.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent)
[![license](https://img.shields.io/npm/l/@ruv.io/neuro-divergent.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/neuro-divergent` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent`](https://crates.io/crates/neuro-divergent) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/neuro-divergent
```

### Using yarn

```bash
yarn add @ruv.io/neuro-divergent
```

### Using pnpm

```bash
pnpm add @ruv.io/neuro-divergent
```
...
- **Linux x64**: `@ruv.io/neuro-divergent-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/neuro-divergent-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/neuro-divergent-darwin-x64`
- **macOS ARM64**: `@ruv.io/neuro-divergent-darwin-arm64`
- **Windows x64**: `@ruv.io/neuro-divergent-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/neuro-divergent-wasm32` (fallback)
...
```typescript
import { NeuroDivergent } from '@ruv.io/neuro-divergent'
...
```typescript
import { NeuroDivergent, Config } from '@ruv.io/neuro-divergent'
...
// CommonJS
const { NeuroDivergent } = require('@ruv.io/neuro-divergent')
```
...
```typescript
import { NeuroDivergent, NeuroDivergentError } from '@ruv.io/neuro-divergent'
...
```typescript
import { NeuroDivergent, Config, LogLevel } from '@ruv.io/neuro-divergent'
...
cd ruv.io/packages/neuro-divergent
...
- **NPM Package**: [@ruv.io/neuro-divergent](https://www.npmjs.com/package/@ruv.io/neuro-divergent)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [neuro-divergent](https://crates.io/crates/neuro-divergent)
- **Documentation**: [docs.ruv.io/neuro-divergent](https://docs.ruv.io/neuro-divergent)
...
![NPM](https://nodei.co/npm/@ruv.io/neuro-divergent.png?downloads=true&downloadRank=true&stars=true)
