# 📐 @ruv.io/geometric-langlands-cli

> User-friendly CLI for the Geometric Langlands computational framework

[![npm version](https://img.shields.io/npm/v/@ruv.io/geometric-langlands-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/geometric-langlands-cli)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/geometric-langlands-cli.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/geometric-langlands-cli)
[![license](https://img.shields.io/npm/l/@ruv.io/geometric-langlands-cli.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/geometric-langlands-cli` is a high-performance Node.js native addon that provides TypeScript bindings for the [`geometric-langlands-cli`](https://crates.io/crates/geometric-langlands-cli) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/geometric-langlands-cli
```

### Using yarn

```bash
yarn add @ruv.io/geometric-langlands-cli
```

### Using pnpm

```bash
pnpm add @ruv.io/geometric-langlands-cli
```
...
- **Linux x64**: `@ruv.io/geometric-langlands-cli-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/geometric-langlands-cli-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/geometric-langlands-cli-darwin-x64`
- **macOS ARM64**: `@ruv.io/geometric-langlands-cli-darwin-arm64`
- **Windows x64**: `@ruv.io/geometric-langlands-cli-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/geometric-langlands-cli-wasm32` (fallback)
...
```typescript
import { GeometricLanglandsCli } from '@ruv.io/geometric-langlands-cli'
...
```typescript
import { GeometricLanglandsCli, Config } from '@ruv.io/geometric-langlands-cli'
...
// CommonJS
const { GeometricLanglandsCli } = require('@ruv.io/geometric-langlands-cli')
```
...
```typescript
import { GeometricLanglandsCli, GeometricLanglandsCliError } from '@ruv.io/geometric-langlands-cli'
...
```typescript
import { GeometricLanglandsCli, Config, LogLevel } from '@ruv.io/geometric-langlands-cli'
...
cd ruv.io/packages/geometric-langlands-cli
...
- **NPM Package**: [@ruv.io/geometric-langlands-cli](https://www.npmjs.com/package/@ruv.io/geometric-langlands-cli)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [geometric-langlands-cli](https://crates.io/crates/geometric-langlands-cli)
- **Documentation**: [docs.ruv.io/geometric-langlands-cli](https://docs.ruv.io/geometric-langlands-cli)
...
![NPM](https://nodei.co/npm/@ruv.io/geometric-langlands-cli.png?downloads=true&downloadRank=true&stars=true)
