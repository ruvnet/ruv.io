# 📦 @ruv.io/daa-prime-trainer

> Distributed SGD/FSDP trainer for Prime ML framework

[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-prime-trainer.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-prime-trainer)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-prime-trainer.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-prime-trainer)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-prime-trainer.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-prime-trainer` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-prime-trainer`](https://crates.io/crates/daa-prime-trainer) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-prime-trainer
```

### Using yarn

```bash
yarn add @ruv.io/daa-prime-trainer
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-prime-trainer
```
...
- **Linux x64**: `@ruv.io/daa-prime-trainer-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-prime-trainer-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-prime-trainer-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-prime-trainer-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-prime-trainer-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-prime-trainer-wasm32` (fallback)
...
```typescript
import { DaaPrimeTrainer } from '@ruv.io/daa-prime-trainer'
...
```typescript
import { DaaPrimeTrainer, Config } from '@ruv.io/daa-prime-trainer'
...
// CommonJS
const { DaaPrimeTrainer } = require('@ruv.io/daa-prime-trainer')
```
...
```typescript
import { DaaPrimeTrainer, DaaPrimeTrainerError } from '@ruv.io/daa-prime-trainer'
...
```typescript
import { DaaPrimeTrainer, Config, LogLevel } from '@ruv.io/daa-prime-trainer'
...
cd ruv.io/packages/daa-prime-trainer
...
- **NPM Package**: [@ruv.io/daa-prime-trainer](https://www.npmjs.com/package/@ruv.io/daa-prime-trainer)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-prime-trainer](https://crates.io/crates/daa-prime-trainer)
- **Documentation**: [docs.ruv.io/daa-prime-trainer](https://docs.ruv.io/daa-prime-trainer)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-prime-trainer.png?downloads=true&downloadRank=true&stars=true)
