# 🧠 @ruv.io/temporal-neural-solver

> Ultra-fast neural network inference with sub-microsecond latency

[![npm version](https://img.shields.io/npm/v/@ruv.io/temporal-neural-solver.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/temporal-neural-solver)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/temporal-neural-solver.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/temporal-neural-solver)
[![license](https://img.shields.io/npm/l/@ruv.io/temporal-neural-solver.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/temporal-neural-solver` is a high-performance Node.js native addon that provides TypeScript bindings for the [`temporal-neural-solver`](https://crates.io/crates/temporal-neural-solver) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/temporal-neural-solver
```

### Using yarn

```bash
yarn add @ruv.io/temporal-neural-solver
```

### Using pnpm

```bash
pnpm add @ruv.io/temporal-neural-solver
```
...
- **Linux x64**: `@ruv.io/temporal-neural-solver-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/temporal-neural-solver-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/temporal-neural-solver-darwin-x64`
- **macOS ARM64**: `@ruv.io/temporal-neural-solver-darwin-arm64`
- **Windows x64**: `@ruv.io/temporal-neural-solver-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/temporal-neural-solver-wasm32` (fallback)
...
```typescript
import { TemporalNeuralSolver } from '@ruv.io/temporal-neural-solver'
...
```typescript
import { TemporalNeuralSolver, Config } from '@ruv.io/temporal-neural-solver'
...
// CommonJS
const { TemporalNeuralSolver } = require('@ruv.io/temporal-neural-solver')
```
...
```typescript
import { TemporalNeuralSolver, TemporalNeuralSolverError } from '@ruv.io/temporal-neural-solver'
...
```typescript
import { TemporalNeuralSolver, Config, LogLevel } from '@ruv.io/temporal-neural-solver'
...
cd ruv.io/packages/temporal-neural-solver
...
- **NPM Package**: [@ruv.io/temporal-neural-solver](https://www.npmjs.com/package/@ruv.io/temporal-neural-solver)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [temporal-neural-solver](https://crates.io/crates/temporal-neural-solver)
- **Documentation**: [docs.ruv.io/temporal-neural-solver](https://docs.ruv.io/temporal-neural-solver)
...
![NPM](https://nodei.co/npm/@ruv.io/temporal-neural-solver.png?downloads=true&downloadRank=true&stars=true)
