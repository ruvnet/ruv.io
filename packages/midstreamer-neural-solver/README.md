# 🧠 @ruv.io/midstreamer-neural-solver

> Temporal logic with neural reasoning

[![npm version](https://img.shields.io/npm/v/@ruv.io/midstreamer-neural-solver.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-neural-solver)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/midstreamer-neural-solver.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-neural-solver)
[![license](https://img.shields.io/npm/l/@ruv.io/midstreamer-neural-solver.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/midstreamer-neural-solver` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-neural-solver`](https://crates.io/crates/midstreamer-neural-solver) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/midstreamer-neural-solver
```

### Using yarn

```bash
yarn add @ruv.io/midstreamer-neural-solver
```

### Using pnpm

```bash
pnpm add @ruv.io/midstreamer-neural-solver
```
...
- **Linux x64**: `@ruv.io/midstreamer-neural-solver-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/midstreamer-neural-solver-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/midstreamer-neural-solver-darwin-x64`
- **macOS ARM64**: `@ruv.io/midstreamer-neural-solver-darwin-arm64`
- **Windows x64**: `@ruv.io/midstreamer-neural-solver-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/midstreamer-neural-solver-wasm32` (fallback)
...
```typescript
import { MidstreamerNeuralSolver } from '@ruv.io/midstreamer-neural-solver'
...
```typescript
import { MidstreamerNeuralSolver, Config } from '@ruv.io/midstreamer-neural-solver'
...
// CommonJS
const { MidstreamerNeuralSolver } = require('@ruv.io/midstreamer-neural-solver')
```
...
```typescript
import { MidstreamerNeuralSolver, MidstreamerNeuralSolverError } from '@ruv.io/midstreamer-neural-solver'
...
```typescript
import { MidstreamerNeuralSolver, Config, LogLevel } from '@ruv.io/midstreamer-neural-solver'
...
cd ruv.io/packages/midstreamer-neural-solver
...
- **NPM Package**: [@ruv.io/midstreamer-neural-solver](https://www.npmjs.com/package/@ruv.io/midstreamer-neural-solver)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [midstreamer-neural-solver](https://crates.io/crates/midstreamer-neural-solver)
- **Documentation**: [docs.ruv.io/midstreamer-neural-solver](https://docs.ruv.io/midstreamer-neural-solver)
...
![NPM](https://nodei.co/npm/@ruv.io/midstreamer-neural-solver.png?downloads=true&downloadRank=true&stars=true)
