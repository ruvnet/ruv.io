# ⏰ @ruv.io/midstreamer-quic

> QUIC multi-stream support for native and WASM targets

[![npm version](https://img.shields.io/npm/v/@ruv.io/midstreamer-quic.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-quic)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/midstreamer-quic.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-quic)
[![license](https://img.shields.io/npm/l/@ruv.io/midstreamer-quic.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/midstreamer-quic` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-quic`](https://crates.io/crates/midstreamer-quic) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/midstreamer-quic
```

### Using yarn

```bash
yarn add @ruv.io/midstreamer-quic
```

### Using pnpm

```bash
pnpm add @ruv.io/midstreamer-quic
```
...
- **Linux x64**: `@ruv.io/midstreamer-quic-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/midstreamer-quic-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/midstreamer-quic-darwin-x64`
- **macOS ARM64**: `@ruv.io/midstreamer-quic-darwin-arm64`
- **Windows x64**: `@ruv.io/midstreamer-quic-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/midstreamer-quic-wasm32` (fallback)
...
```typescript
import { MidstreamerQuic } from '@ruv.io/midstreamer-quic'
...
```typescript
import { MidstreamerQuic, Config } from '@ruv.io/midstreamer-quic'
...
// CommonJS
const { MidstreamerQuic } = require('@ruv.io/midstreamer-quic')
```
...
```typescript
import { MidstreamerQuic, MidstreamerQuicError } from '@ruv.io/midstreamer-quic'
...
```typescript
import { MidstreamerQuic, Config, LogLevel } from '@ruv.io/midstreamer-quic'
...
cd ruv.io/packages/midstreamer-quic
...
- **NPM Package**: [@ruv.io/midstreamer-quic](https://www.npmjs.com/package/@ruv.io/midstreamer-quic)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [midstreamer-quic](https://crates.io/crates/midstreamer-quic)
- **Documentation**: [docs.ruv.io/midstreamer-quic](https://docs.ruv.io/midstreamer-quic)
...
![NPM](https://nodei.co/npm/@ruv.io/midstreamer-quic.png?downloads=true&downloadRank=true&stars=true)
