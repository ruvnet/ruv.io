# ⏰ @ruv.io/midstreamer-attractor

> Dynamical systems and strange attractors analysis

[![npm version](https://img.shields.io/npm/v/@ruv.io/midstreamer-attractor.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-attractor)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/midstreamer-attractor.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/midstreamer-attractor)
[![license](https://img.shields.io/npm/l/@ruv.io/midstreamer-attractor.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/midstreamer-attractor` is a high-performance Node.js native addon that provides TypeScript bindings for the [`midstreamer-attractor`](https://crates.io/crates/midstreamer-attractor) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/midstreamer-attractor
```

### Using yarn

```bash
yarn add @ruv.io/midstreamer-attractor
```

### Using pnpm

```bash
pnpm add @ruv.io/midstreamer-attractor
```
...
- **Linux x64**: `@ruv.io/midstreamer-attractor-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/midstreamer-attractor-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/midstreamer-attractor-darwin-x64`
- **macOS ARM64**: `@ruv.io/midstreamer-attractor-darwin-arm64`
- **Windows x64**: `@ruv.io/midstreamer-attractor-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/midstreamer-attractor-wasm32` (fallback)
...
```typescript
import { MidstreamerAttractor } from '@ruv.io/midstreamer-attractor'
...
```typescript
import { MidstreamerAttractor, Config } from '@ruv.io/midstreamer-attractor'
...
// CommonJS
const { MidstreamerAttractor } = require('@ruv.io/midstreamer-attractor')
```
...
```typescript
import { MidstreamerAttractor, MidstreamerAttractorError } from '@ruv.io/midstreamer-attractor'
...
```typescript
import { MidstreamerAttractor, Config, LogLevel } from '@ruv.io/midstreamer-attractor'
...
cd ruv.io/packages/midstreamer-attractor
...
- **NPM Package**: [@ruv.io/midstreamer-attractor](https://www.npmjs.com/package/@ruv.io/midstreamer-attractor)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [midstreamer-attractor](https://crates.io/crates/midstreamer-attractor)
- **Documentation**: [docs.ruv.io/midstreamer-attractor](https://docs.ruv.io/midstreamer-attractor)
...
![NPM](https://nodei.co/npm/@ruv.io/midstreamer-attractor.png?downloads=true&downloadRank=true&stars=true)
