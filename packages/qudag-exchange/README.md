# ⚛️ @ruv.io/qudag-exchange

> QuDAG Exchange: Quantum-resistant token exchange with rUv (Resource Utilization Voucher) system

[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag-exchange.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-exchange)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag-exchange.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-exchange)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag-exchange.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qudag-exchange` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-exchange`](https://crates.io/crates/qudag-exchange) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qudag-exchange
```

### Using yarn

```bash
yarn add @ruv.io/qudag-exchange
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag-exchange
```
...
- **Linux x64**: `@ruv.io/qudag-exchange-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-exchange-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-exchange-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-exchange-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-exchange-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-exchange-wasm32` (fallback)
...
```typescript
import { QudagExchange } from '@ruv.io/qudag-exchange'
...
```typescript
import { QudagExchange, Config } from '@ruv.io/qudag-exchange'
...
// CommonJS
const { QudagExchange } = require('@ruv.io/qudag-exchange')
```
...
```typescript
import { QudagExchange, QudagExchangeError } from '@ruv.io/qudag-exchange'
...
```typescript
import { QudagExchange, Config, LogLevel } from '@ruv.io/qudag-exchange'
...
cd ruv.io/packages/qudag-exchange
...
- **NPM Package**: [@ruv.io/qudag-exchange](https://www.npmjs.com/package/@ruv.io/qudag-exchange)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag-exchange](https://crates.io/crates/qudag-exchange)
- **Documentation**: [docs.ruv.io/qudag-exchange](https://docs.ruv.io/qudag-exchange)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag-exchange.png?downloads=true&downloadRank=true&stars=true)
