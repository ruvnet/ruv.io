...
[![npm version](https://img.shields.io/npm/v/@ruv.io/aimds-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/aimds-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/aimds-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/aimds-core)
[![license](https://img.shields.io/npm/l/@ruv.io/aimds-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/aimds-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`aimds-core`](https://crates.io/crates/aimds-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/aimds-core
```

### Using yarn

```bash
yarn add @ruv.io/aimds-core
```

### Using pnpm

```bash
pnpm add @ruv.io/aimds-core
```
...
- **Linux x64**: `@ruv.io/aimds-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/aimds-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/aimds-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/aimds-core-darwin-arm64`
- **Windows x64**: `@ruv.io/aimds-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/aimds-core-wasm32` (fallback)
...
```typescript
import { AimdsCore } from '@ruv.io/aimds-core'
...
```typescript
import { AimdsCore, Config } from '@ruv.io/aimds-core'
...
// CommonJS
const { AimdsCore } = require('@ruv.io/aimds-core')
```
...
```typescript
import { AimdsCore, AimdsCoreError } from '@ruv.io/aimds-core'
...
```typescript
import { AimdsCore, Config, LogLevel } from '@ruv.io/aimds-core'
...
- **NPM Package**: [@ruv.io/aimds-core](https://www.npmjs.com/package/@ruv.io/aimds-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [aimds-core](https://crates.io/crates/aimds-core)
- **Documentation**: [docs.ruv.io/aimds-core](https://docs.ruv.io/aimds-core)
...
![NPM](https://nodei.co/npm/@ruv.io/aimds-core.png?downloads=true&downloadRank=true&stars=true)
