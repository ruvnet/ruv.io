# ⚛️ @ruv.io/qudag-protocol

> Protocol implementation for QuDAG - Orchestrates crypto, DAG, and network components

[![npm version](https://img.shields.io/npm/v/@ruv.io/qudag-protocol.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-protocol)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/qudag-protocol.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/qudag-protocol)
[![license](https://img.shields.io/npm/l/@ruv.io/qudag-protocol.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/qudag-protocol` is a high-performance Node.js native addon that provides TypeScript bindings for the [`qudag-protocol`](https://crates.io/crates/qudag-protocol) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/qudag-protocol
```

### Using yarn

```bash
yarn add @ruv.io/qudag-protocol
```

### Using pnpm

```bash
pnpm add @ruv.io/qudag-protocol
```
...
- **Linux x64**: `@ruv.io/qudag-protocol-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/qudag-protocol-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/qudag-protocol-darwin-x64`
- **macOS ARM64**: `@ruv.io/qudag-protocol-darwin-arm64`
- **Windows x64**: `@ruv.io/qudag-protocol-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/qudag-protocol-wasm32` (fallback)
...
```typescript
import { QudagProtocol } from '@ruv.io/qudag-protocol'
...
```typescript
import { QudagProtocol, Config } from '@ruv.io/qudag-protocol'
...
// CommonJS
const { QudagProtocol } = require('@ruv.io/qudag-protocol')
```
...
```typescript
import { QudagProtocol, QudagProtocolError } from '@ruv.io/qudag-protocol'
...
```typescript
import { QudagProtocol, Config, LogLevel } from '@ruv.io/qudag-protocol'
...
cd ruv.io/packages/qudag-protocol
...
- **NPM Package**: [@ruv.io/qudag-protocol](https://www.npmjs.com/package/@ruv.io/qudag-protocol)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [qudag-protocol](https://crates.io/crates/qudag-protocol)
- **Documentation**: [docs.ruv.io/qudag-protocol](https://docs.ruv.io/qudag-protocol)
...
![NPM](https://nodei.co/npm/@ruv.io/qudag-protocol.png?downloads=true&downloadRank=true&stars=true)
