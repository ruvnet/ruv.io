...
[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-utils.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-utils)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-utils.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-utils)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-utils.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-utils` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-utils`](https://crates.io/crates/nt-utils) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-utils
```

### Using yarn

```bash
yarn add @ruv.io/nt-utils
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-utils
```
...
- **Linux x64**: `@ruv.io/nt-utils-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-utils-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-utils-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-utils-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-utils-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-utils-wasm32` (fallback)
...
```typescript
import { NtUtils } from '@ruv.io/nt-utils'
...
```typescript
import { NtUtils, Config } from '@ruv.io/nt-utils'
...
// CommonJS
const { NtUtils } = require('@ruv.io/nt-utils')
```
...
```typescript
import { NtUtils, NtUtilsError } from '@ruv.io/nt-utils'
...
```typescript
import { NtUtils, Config, LogLevel } from '@ruv.io/nt-utils'
...
- **NPM Package**: [@ruv.io/nt-utils](https://www.npmjs.com/package/@ruv.io/nt-utils)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-utils](https://crates.io/crates/nt-utils)
- **Documentation**: [docs.ruv.io/nt-utils](https://docs.ruv.io/nt-utils)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-utils.png?downloads=true&downloadRank=true&stars=true)
