# 📦 @ruv.io/nt-napi-bindings

> Node.js N-API bindings for Neural Trader - High-performance TypeScript/JavaScript interface

[![npm version](https://img.shields.io/npm/v/@ruv.io/nt-napi-bindings.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-napi-bindings)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/nt-napi-bindings.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/nt-napi-bindings)
[![license](https://img.shields.io/npm/l/@ruv.io/nt-napi-bindings.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/nt-napi-bindings` is a high-performance Node.js native addon that provides TypeScript bindings for the [`nt-napi-bindings`](https://crates.io/crates/nt-napi-bindings) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/nt-napi-bindings
```

### Using yarn

```bash
yarn add @ruv.io/nt-napi-bindings
```

### Using pnpm

```bash
pnpm add @ruv.io/nt-napi-bindings
```
...
- **Linux x64**: `@ruv.io/nt-napi-bindings-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/nt-napi-bindings-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/nt-napi-bindings-darwin-x64`
- **macOS ARM64**: `@ruv.io/nt-napi-bindings-darwin-arm64`
- **Windows x64**: `@ruv.io/nt-napi-bindings-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/nt-napi-bindings-wasm32` (fallback)
...
```typescript
import { NtNapiBindings } from '@ruv.io/nt-napi-bindings'
...
```typescript
import { NtNapiBindings, Config } from '@ruv.io/nt-napi-bindings'
...
// CommonJS
const { NtNapiBindings } = require('@ruv.io/nt-napi-bindings')
```
...
```typescript
import { NtNapiBindings, NtNapiBindingsError } from '@ruv.io/nt-napi-bindings'
...
```typescript
import { NtNapiBindings, Config, LogLevel } from '@ruv.io/nt-napi-bindings'
...
cd ruv.io/packages/nt-napi-bindings
...
- **NPM Package**: [@ruv.io/nt-napi-bindings](https://www.npmjs.com/package/@ruv.io/nt-napi-bindings)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [nt-napi-bindings](https://crates.io/crates/nt-napi-bindings)
- **Documentation**: [docs.ruv.io/nt-napi-bindings](https://docs.ruv.io/nt-napi-bindings)
...
![NPM](https://nodei.co/npm/@ruv.io/nt-napi-bindings.png?downloads=true&downloadRank=true&stars=true)
