...
[![npm version](https://img.shields.io/npm/v/@ruv.io/goalie.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/goalie)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/goalie.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/goalie)
[![license](https://img.shields.io/npm/l/@ruv.io/goalie.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/goalie` is a high-performance Node.js native addon that provides TypeScript bindings for the [`goalie`](https://crates.io/crates/goalie) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/goalie
```

### Using yarn

```bash
yarn add @ruv.io/goalie
```

### Using pnpm

```bash
pnpm add @ruv.io/goalie
```
...
- **Linux x64**: `@ruv.io/goalie-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/goalie-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/goalie-darwin-x64`
- **macOS ARM64**: `@ruv.io/goalie-darwin-arm64`
- **Windows x64**: `@ruv.io/goalie-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/goalie-wasm32` (fallback)
...
```typescript
import { Goalie } from '@ruv.io/goalie'
...
```typescript
import { Goalie, Config } from '@ruv.io/goalie'
...
// CommonJS
const { Goalie } = require('@ruv.io/goalie')
```
...
```typescript
import { Goalie, GoalieError } from '@ruv.io/goalie'
...
```typescript
import { Goalie, Config, LogLevel } from '@ruv.io/goalie'
...
- **NPM Package**: [@ruv.io/goalie](https://www.npmjs.com/package/@ruv.io/goalie)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [goalie](https://crates.io/crates/goalie)
- **Documentation**: [docs.ruv.io/goalie](https://docs.ruv.io/goalie)
...
![NPM](https://nodei.co/npm/@ruv.io/goalie.png?downloads=true&downloadRank=true&stars=true)
