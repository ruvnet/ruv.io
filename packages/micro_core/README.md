...
[![npm version](https://img.shields.io/npm/v/@ruv.io/micro_core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/micro_core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/micro_core)
[![license](https://img.shields.io/npm/l/@ruv.io/micro_core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/micro_core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`micro_core`](https://crates.io/crates/micro_core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/micro_core
```

### Using yarn

```bash
yarn add @ruv.io/micro_core
```

### Using pnpm

```bash
pnpm add @ruv.io/micro_core
```
...
- **Linux x64**: `@ruv.io/micro_core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/micro_core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/micro_core-darwin-x64`
- **macOS ARM64**: `@ruv.io/micro_core-darwin-arm64`
- **Windows x64**: `@ruv.io/micro_core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/micro_core-wasm32` (fallback)
...
```typescript
import { Micro_core } from '@ruv.io/micro_core'
...
```typescript
import { Micro_core, Config } from '@ruv.io/micro_core'
...
// CommonJS
const { Micro_core } = require('@ruv.io/micro_core')
```
...
```typescript
import { Micro_core, Micro_coreError } from '@ruv.io/micro_core'
...
```typescript
import { Micro_core, Config, LogLevel } from '@ruv.io/micro_core'
...
- **NPM Package**: [@ruv.io/micro_core](https://www.npmjs.com/package/@ruv.io/micro_core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [micro_core](https://crates.io/crates/micro_core)
- **Documentation**: [docs.ruv.io/micro_core](https://docs.ruv.io/micro_core)
...
![NPM](https://nodei.co/npm/@ruv.io/micro_core.png?downloads=true&downloadRank=true&stars=true)
