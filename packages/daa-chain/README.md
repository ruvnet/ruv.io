...
[![npm version](https://img.shields.io/npm/v/@ruv.io/daa-chain.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-chain)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/daa-chain.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/daa-chain)
[![license](https://img.shields.io/npm/l/@ruv.io/daa-chain.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/daa-chain` is a high-performance Node.js native addon that provides TypeScript bindings for the [`daa-chain`](https://crates.io/crates/daa-chain) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/daa-chain
```

### Using yarn

```bash
yarn add @ruv.io/daa-chain
```

### Using pnpm

```bash
pnpm add @ruv.io/daa-chain
```
...
- **Linux x64**: `@ruv.io/daa-chain-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/daa-chain-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/daa-chain-darwin-x64`
- **macOS ARM64**: `@ruv.io/daa-chain-darwin-arm64`
- **Windows x64**: `@ruv.io/daa-chain-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/daa-chain-wasm32` (fallback)
...
```typescript
import { DaaChain } from '@ruv.io/daa-chain'
...
```typescript
import { DaaChain, Config } from '@ruv.io/daa-chain'
...
// CommonJS
const { DaaChain } = require('@ruv.io/daa-chain')
```
...
```typescript
import { DaaChain, DaaChainError } from '@ruv.io/daa-chain'
...
```typescript
import { DaaChain, Config, LogLevel } from '@ruv.io/daa-chain'
...
- **NPM Package**: [@ruv.io/daa-chain](https://www.npmjs.com/package/@ruv.io/daa-chain)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [daa-chain](https://crates.io/crates/daa-chain)
- **Documentation**: [docs.ruv.io/daa-chain](https://docs.ruv.io/daa-chain)
...
![NPM](https://nodei.co/npm/@ruv.io/daa-chain.png?downloads=true&downloadRank=true&stars=true)
