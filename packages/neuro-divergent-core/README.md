# 🧠 @ruv.io/neuro-divergent-core

> Core foundation for neuro-divergent neural forecasting library

[![npm version](https://img.shields.io/npm/v/@ruv.io/neuro-divergent-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent-core)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/neuro-divergent-core.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/neuro-divergent-core)
[![license](https://img.shields.io/npm/l/@ruv.io/neuro-divergent-core.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/neuro-divergent-core` is a high-performance Node.js native addon that provides TypeScript bindings for the [`neuro-divergent-core`](https://crates.io/crates/neuro-divergent-core) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/neuro-divergent-core
```

### Using yarn

```bash
yarn add @ruv.io/neuro-divergent-core
```

### Using pnpm

```bash
pnpm add @ruv.io/neuro-divergent-core
```
...
- **Linux x64**: `@ruv.io/neuro-divergent-core-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/neuro-divergent-core-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/neuro-divergent-core-darwin-x64`
- **macOS ARM64**: `@ruv.io/neuro-divergent-core-darwin-arm64`
- **Windows x64**: `@ruv.io/neuro-divergent-core-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/neuro-divergent-core-wasm32` (fallback)
...
```typescript
import { NeuroDivergentCore } from '@ruv.io/neuro-divergent-core'
...
```typescript
import { NeuroDivergentCore, Config } from '@ruv.io/neuro-divergent-core'
...
// CommonJS
const { NeuroDivergentCore } = require('@ruv.io/neuro-divergent-core')
```
...
```typescript
import { NeuroDivergentCore, NeuroDivergentCoreError } from '@ruv.io/neuro-divergent-core'
...
```typescript
import { NeuroDivergentCore, Config, LogLevel } from '@ruv.io/neuro-divergent-core'
...
cd ruv.io/packages/neuro-divergent-core
...
- **NPM Package**: [@ruv.io/neuro-divergent-core](https://www.npmjs.com/package/@ruv.io/neuro-divergent-core)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [neuro-divergent-core](https://crates.io/crates/neuro-divergent-core)
- **Documentation**: [docs.ruv.io/neuro-divergent-core](https://docs.ruv.io/neuro-divergent-core)
...
![NPM](https://nodei.co/npm/@ruv.io/neuro-divergent-core.png?downloads=true&downloadRank=true&stars=true)
