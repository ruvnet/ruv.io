...
[![npm version](https://img.shields.io/npm/v/@ruv.io/leanr-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/leanr-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/leanr-wasm.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/leanr-wasm)
[![license](https://img.shields.io/npm/l/@ruv.io/leanr-wasm.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/leanr-wasm` is a high-performance Node.js native addon that provides TypeScript bindings for the [`leanr-wasm`](https://crates.io/crates/leanr-wasm) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/leanr-wasm
```

### Using yarn

```bash
yarn add @ruv.io/leanr-wasm
```

### Using pnpm

```bash
pnpm add @ruv.io/leanr-wasm
```
...
- **Linux x64**: `@ruv.io/leanr-wasm-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/leanr-wasm-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/leanr-wasm-darwin-x64`
- **macOS ARM64**: `@ruv.io/leanr-wasm-darwin-arm64`
- **Windows x64**: `@ruv.io/leanr-wasm-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/leanr-wasm-wasm32` (fallback)
...
```typescript
import { LeanrWasm } from '@ruv.io/leanr-wasm'
...
```typescript
import { LeanrWasm, Config } from '@ruv.io/leanr-wasm'
...
// CommonJS
const { LeanrWasm } = require('@ruv.io/leanr-wasm')
```
...
```typescript
import { LeanrWasm, LeanrWasmError } from '@ruv.io/leanr-wasm'
...
```typescript
import { LeanrWasm, Config, LogLevel } from '@ruv.io/leanr-wasm'
...
- **NPM Package**: [@ruv.io/leanr-wasm](https://www.npmjs.com/package/@ruv.io/leanr-wasm)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [leanr-wasm](https://crates.io/crates/leanr-wasm)
- **Documentation**: [docs.ruv.io/leanr-wasm](https://docs.ruv.io/leanr-wasm)
...
![NPM](https://nodei.co/npm/@ruv.io/leanr-wasm.png?downloads=true&downloadRank=true&stars=true)
