# 📦 @ruv.io/kimi-expert-analyzer

> Expert analysis tool for Kimi-K2 to Rust-WASM conversion

[![npm version](https://img.shields.io/npm/v/@ruv.io/kimi-expert-analyzer.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/kimi-expert-analyzer)
[![npm downloads](https://img.shields.io/npm/dm/@ruv.io/kimi-expert-analyzer.svg?style=flat-square)](https://www.npmjs.com/package/@ruv.io/kimi-expert-analyzer)
[![license](https://img.shields.io/npm/l/@ruv.io/kimi-expert-analyzer.svg?style=flat-square)](https://github.com/ruvnet/ruv.io/blob/main/LICENSE)
...
`@ruv.io/kimi-expert-analyzer` is a high-performance Node.js native addon that provides TypeScript bindings for the [`kimi-expert-analyzer`](https://crates.io/crates/kimi-expert-analyzer) Rust crate. Built with [napi-rs](https://napi.rs/), it delivers native performance with a modern JavaScript API.
...
```bash
npm install @ruv.io/kimi-expert-analyzer
```

### Using yarn

```bash
yarn add @ruv.io/kimi-expert-analyzer
```

### Using pnpm

```bash
pnpm add @ruv.io/kimi-expert-analyzer
```
...
- **Linux x64**: `@ruv.io/kimi-expert-analyzer-linux-x64-gnu`
- **Linux ARM64**: `@ruv.io/kimi-expert-analyzer-linux-arm64-gnu`
- **macOS x64**: `@ruv.io/kimi-expert-analyzer-darwin-x64`
- **macOS ARM64**: `@ruv.io/kimi-expert-analyzer-darwin-arm64`
- **Windows x64**: `@ruv.io/kimi-expert-analyzer-win32-x64-msvc`
- **WebAssembly**: `@ruv.io/kimi-expert-analyzer-wasm32` (fallback)
...
```typescript
import { KimiExpertAnalyzer } from '@ruv.io/kimi-expert-analyzer'
...
```typescript
import { KimiExpertAnalyzer, Config } from '@ruv.io/kimi-expert-analyzer'
...
// CommonJS
const { KimiExpertAnalyzer } = require('@ruv.io/kimi-expert-analyzer')
```
...
```typescript
import { KimiExpertAnalyzer, KimiExpertAnalyzerError } from '@ruv.io/kimi-expert-analyzer'
...
```typescript
import { KimiExpertAnalyzer, Config, LogLevel } from '@ruv.io/kimi-expert-analyzer'
...
cd ruv.io/packages/kimi-expert-analyzer
...
- **NPM Package**: [@ruv.io/kimi-expert-analyzer](https://www.npmjs.com/package/@ruv.io/kimi-expert-analyzer)
- **GitHub Repository**: [ruvnet/ruv.io](https://github.com/ruvnet/ruv.io)
- **Rust Crate**: [kimi-expert-analyzer](https://crates.io/crates/kimi-expert-analyzer)
- **Documentation**: [docs.ruv.io/kimi-expert-analyzer](https://docs.ruv.io/kimi-expert-analyzer)
...
![NPM](https://nodei.co/npm/@ruv.io/kimi-expert-analyzer.png?downloads=true&downloadRank=true&stars=true)
